(function (m, t, A) {
    ...
    function Ob(a, b, c, d, f) {
        ...
        function C(a) {
            ...
            a:{
                ...
                for (var H = 0; H < z.length; H++) if ((!z[H].id || "string" != typeof z[H].id) && w.calcAttribChecksum(z[H]) == C && w.calcTextChecksum(z[H]) == k) {
                    z = !0;
                    break a
                }
                z = !1
        ...
        function Ta(a, e) {
            var b = e[V];
            if (0 < b) {
                var c = [], k = w.getElementRegion(e), g = Ka[b], d = k[0] + "x" + k[1], f = k[2] + "x" + k[3];
                if (d != g.pos) {
                    g.pos = d;
        ...
        function N(a) {
            ...
            for (var k = -1, g = a.form.elements, d = g.length, f = 0, q = 0; f < d; f++) if (g[f].name ==
                a.name) {
                if (g[f] == a) {
                    k = q;
                    break
        ...
        function fb(a, e) {
            ...
            if (0 > b) return null;
            for (var c = e.elements, k = c.length, g = [], d = 0; d < k; d++) if (!w.isEmptyField(c[d])) {
                var f = c[d][V];
        ...
        }(), aa = 1, ka = /^(password|passwd|pswd)$/, Ha = !0, Aa = !1, Ma = "", Na = !1, sa = !0;
        v.initCorrector();
        v.nowTime();
    ...
    var Oa = !1, wb = "undefined" !== typeof Object && "function" === typeof Object.defineProperty;
    try {
        if (wb) var Wb = function (a) {
            ...
            a = c(9);
            var r = c(2), u = a.a.Map, p = a.a.Set, C = {
            ...
            var d = c.n(a), f = c(9), l = f.a.Object.assign || function (a) {
                for (var b = 1; b < arguments.length; b++) {
                    var c = arguments[b], g = f.a.Object.prototype.hasOwnProperty.bind(c), d;
            ...
            var n = {
                assign: function (a) {
                    ...
                    for (var c = b.split("."), g = a, d = 0, k = c.length; d < k; d++) if (g = g[c[d]], null == g) return A;
                    return g
            ...
            Object(a.a)(r, function (a) {
                ...
                p[a] = u ? e ? (b = r[a]).bind.apply(b, [r].concat(C)) : r[a] : e ? function () {
                } : r[a]
            }, !0);
            u && (p.devLog = r.log);
            b["default"] = p
            ...
            var d =
                ...
                NodeTypes: {
                    ...
                    var b = a.ownerDocument || a, c = a.documentElement, g = b.defaultView || b.parentWindow,
                        d = b.body;
                    ...
                    var c = a.ownerDocument ? a.ownerDocument.defaultView : m, g = {
                    ...
                    g = [];
                    for (var d = [], k; (k = c.elementFromPoint(a, b)) && -1 === g.indexOf(k);) {
                        g.push(k);
                        var e = k.style;
                        d.push({
                    ...
                    var c = void 0 === b ? {} : b, g = c.excludeBorder, d = void 0 === g ? !1 : g;
                    c = c.excludePadding;
                    var k = void 0 === c ? !1 : c;
                    !1 === "getBoundingClientRect" in a && ("documentElement" in a ? a = a.documentElement : "document" in a && (a = a.document.documentElement));
                    var e = (a.ownerDocument || t).defaultView || m, f = a.getBoundingClientRect();
                    c = f.top;
                    g = f.right;
                    var l = f.bottom;
                    f = f.left;
                    ...
                    return {top: c, right: g, bottom: l, left: f}
                    ...
                    if (g.nodeIsInTree(a)) b(!0); else {
                        var k = a.ownerDocument || t, e = new MutationObserver(function () {
            ...
            var f = c.n(a);
            a = c(13);
            var l = c(2), g = c(0), n = c(10), r = c(16), u = c(3);
            c = a.a.DOMIndexer;
            var p = c.IGNORED_NODES, C = c.IGNORED_ATTRIBUTES, q = c.SKIPPED_ATTRIBUTES, k = c.EXTRA_ATTRIBUTES, e = [],
                B = {}, H = {
                    INPUT: function (a, b) {
                        var e = f()({}, b);
                    ...
                    if ("function" === typeof b && c(a) === NodeFilter.FILTER_ACCEPT &&
                        (b(a), !1 === z(a))) for (a = t.createTreeWalker(a, -1, e ? {acceptNode: c} : null, !1); a.nextNode() && !1 !== b(a.currentNode);) ;
                }, La = function (a, b) {
                    var e = [];
                ...
                var d = c(4), l = c(40), g = c(2), n = c(3), r = {"null": null, undefined: A, "true": !0, "false": !1},
                    u = {
                        delay: function (b, c) {
                            ...
                            return new a(function (a) {
                                var c = t.createElement("textarea"), k = t.body;
                                c.value = b;
                                c.style.opacity = "0";
            ...
            var n = new RegExp("(" + c.join("|") + ")", "i"), r = new RegExp("(" + c.concat(a).join("|") +
                ...
                p = {
                    isValidType: function (a) {
                        ...
                        var c = b || {}, e = c.isEU, g = c.recording.keysMode;
                        c = p.isRecordable(a);
                        var d = p.isPrivateInformationField(a);
                        e = p.isAllowed(a, "explicit" === g) && (!e || !d);
                        return {forceRecord: c, isPrivate: d, isAllowed: e}
                    }, encode: function (a) {
                        void 0 === a && (a = "");
            ...
            b.a = function (a, b, c) {
                void 0 === c && (c = !1);
                var g = 2 === b.length;
                if (a && b instanceof Function) for (var d in a) if (a.hasOwnProperty(d) || !0 === c) {
                    var f = g ? b(d, a[d]) : b(d);
                    if (!0 !== f && !1 === f) break
                }
            }
            ...
            (function (a, c) {
                ...
                b.a = {
                    ...
                    create: function (a, b) {
                        ...
                        var n = void 0 === f ? !1 : f;
                        g = g.context;
                        var q = !0, k = null, e = null, B = null, H = null, z = !1, h = null, m = null;
                        g = {
                            invoke: function () {
            ...
            var d = {
                invoke: function (a, b, c) {
                    ...
                    c = c.raf;
                    c = void 0 === c ? !0 : c;
                    var C = Date.now(), q = !1, k = null, e = c ? this.requestAnimationFrame.bind(this) : G,
                ...
                b.a = function (b) {
                    ...
                    try {
                        if (b.forEach) b.forEach(function (a, b) {
                            ...
                            b && a && b !== a && (e = [b, a]);
                            c.push(e)
                        }); else for (var p = b[a.iterator](), C, q; C = p.next(), q = C.value, !C.done;) c.push(q);
                        return c
                    } catch (k) {
                        return []
                    }
            ...
            (function (a) {
                ...
                b.a = function (b, c) {
                    ...
                    if (b && c instanceof Function) if (null != b[a.iterator]) if (g) if (b instanceof Array) {
                        ...
                        C = c(C);
                        if (!0 !== C && !1 === C) break
                    } else if ("forEach" in b) l(b, c, g); else if (b instanceof Array) for (f = Object(d.a)(b), n = 0; n < f.length && (C = f[n], C = g ? c.apply(void 0, C) : c(C), !0 === C || !1 !== C); n++) ;
                }
            }).call(this, c(25)["default"])
        }, function (a, b, c) {
            (function (a, f, l) {
                ...
                var n = c(15), r = "2d webgl experimental-webgl webgl2 experimental-webgl2 bitmaprenderer".split(" "),
                    ...
                    }(), p = new a, C = HTMLCanvasElement.prototype.getContext, q = function (a) {
                    ...
                    return {
                        inputs: {}, events: {}, create: function (a) {
                            ...
                            if (n.a.isValidNode(a.nativeNode) && "__ym_input_override_test" !== a.nativeNode.getAttribute("class")) {
                                ...
                                this.inputs[c] = {checkable: k, value: b[a]};
                                k = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(b), a) || {};
                                var e = Object.getOwnPropertyDescriptor(b, a) || {}, d = g()({}, k, e);
                            ...
                            this.recorder.errorLogger(function () {
                                var c = a.target, k = b.recorder.indexer.get(c);
                                if (k) {
                                    var e = k.id;
                            ...
                            var k = this.inputs[a], e = k.checkable;
                            k = k.value;
                            if ((!b || -1 !== ["string", "boolean", "number"].indexOf(typeof b)) && b !== k) {
                                if (e) c =
                                    ...
                                    c = this.recorder._getEventObject("change", c, {value: d, hidden: g && !k})
                                }
                        ...
                        checkInpudDescriptorOverrideAbility: function (a) {
                            ...
                            try {
                                ...
                                var k = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(c), "value") || {},
                                    e = Object.getOwnPropertyDescriptor(c, "value") || {}, d = g()({}, k, e);
            ...
            (function (a, f) {
                ...
                b.a = function () {
                    ...
                    }, u = d.a.create(l, {timeout: 0}), p = function (a) {
                        var b = this.stamp;
                        "mousemove" === a.type ? u.call(this, a, b) : l.call(this, {object: a, args: [b]})
                    };
                    return {
                        create: function (a) {
                ...
                b.a = function () {
                    var b,
                        c = new a, l = function (a) {
                            ...
                            a = a.object.target;
                            var k = this.document, e = this.window, d = f.getScroll(a);
            ...
            (function (a) {
                ...
                d = function (b) {
                    ...
                    e.processMutations = function (b) {
                        ...
                        a.fastIterate(b, function (a, b) {
                            if (b.target.parentNode && !h.c.isIgnoredNode(b.target.parentNode)) {
                                ...
                                !1 !== function () {
                                    var a = b.type, e = b.target, k = c.indexer.getIndexedNodeId(e);
                                    if (null == k) return !1;
                                    e = [b, k, e, d];
                                    switch (a) {
                                        case "childList":
                    ...
                    e.processTreeChanges = function (b, c, e, k) {
                        var d = this, g = b.nextSibling, f = b.previousSibling;
                        e = b.meta;
                        b = e.addedNodes;
                        e = e.removedNodes;
                        e = void 0 === e ? [] : e;
                                    ...
                                    if (b) {
                                        var k =
                                            a.combine({
                                                ...
                                                pa: b.parent,
                                                nm: b.name
                                            }, c === e ? {pr: d.getIDForNode(f), nx: d.getIDForNode(g)} : {});
                    ...
                    e.processAttributesChanges =
                        function (a, b, c, e) {
                            ...
                            d = d.newValue;
                            var g = null === d || d === A;
                            this.addChanges(e, "c", {id: b, at: (k = {}, k[a] = {n: d, o: c, r: g}, k)})
                        };
                ...
                d = function (b) {
                    ...
                    k.processMutations = function (a) {
                        ...
                        a = f.reduceRight(a, function (a, e) {
                            var k = e.type, d = e.target, g = b.collectSummary(k, d, c, e);
                            null != g && a.unshift({
                                target: d,
                                type: k,
                                meta: g,
                    ...
                    k.collectSummary = function (a, b, c, k) {
                        switch (a) {
                            case "childList":
                                ...
                                if (0 < b.length || 0 < k.length) return {addedNodes: b, removedNodes: k};
                                break;
                            case "attributes":
                                a = k.attributeName;
                                k = k.oldValue;
                            ...
                            case "characterData":
                                ...
                                b !== k) return {oldValue: k, newValue: b}
                        }
                    };
                    return c
                }(c(15).a);
            ...
            (function (a, f) {
                ...
                var p = c.n(d), h = c(11);
                d = c(15);
                var q = c(33), k = c(0), e = c(2), B = c(23), H = c(16), z = c(3), m = c(17),
                ...
                d = function () {
                    ...
                    c.send = function (a, b) {
                        var c = this, d = void 0 === b ? {} : b, k = d.data, g = d.onResponse, f = d.onTimeout,
                            l = d.receiver, q = d.awaitResponse, n = d.timeoutTime, u = null, p = !1, h = !1, C, m = [],
                            t = Date.now();
                        "function" === typeof g && (p = !0, u = a + "." + this.timestamp, this.listenOnce(function (a) {
                            ...
                            if (b.type === u) e ? r["default"].warn("Seems like you forgot to call `answer` in a message handler. This message requires response.") :
                                ...
                                }), clearTimeout(C)); else return !1
                        }, this.targetWindow));
                        u && m.push("response:" + u);
                        (function Ga() {
                            c._sendMessage({data: k, type: a, target: c._getReceiver(l), flags: m});
                            if (q && p) {
                                var b = n;
                                void 0 === b && (b = 3E4);
                                b = Date.now() - t >= b;
                    ...
                    c._findIframe = function (b, c) {
                        var e = this, d = [].slice.call(t.querySelectorAll("iframe"));
            ...
            function (a, b, c) {
                ...
                (function (a) {
                    ...
                    }, C = new d["default"], q = new d["default"], k = function (a) {
                    ...
                    d = Object.defineProperties({
                        regexp: u, patchCSS: function (a, b) {
                        ...
                        patchURL: function (a, b) {
                            ...
                            var e = u.test("relativePath", b), d = this.getRelativeLocation(c), k = d.host,
                                g = d.protocol;
                            d = d.path || d.pathname || "";
                ...
                a = c(42);
                var d = c(31), f = c(43), l = c(44), g = c(45), n = c(46), r = c(47), u = c(48), h = c(49);
                c = c(50);
                b.a = {
                    ...
                    scroll: n.a, selection: r.a, touch: u.a, zoom: h.a, window: c.a, srcset: function () {
                        return {
                            create: function (a) {
                ...
                (function (a, f, l) {
                    ...
                    var k = c.n(d);
                    d = c(1);
                    var e = c.n(d), B = c(16), H = c(23), z = c(0), ca = c(13), x = c(30), w = c(63), y = c(51),
                        v = c(53), D = c(17), E = c(54), F = c(55), J = c(56), L = c(57);
                    d = c(15);
                        ...
                        function c(c, d) {
                            ...
                            e()(q()(k), "_slaveMessengerRegistrationHandler", function (a, b) {
                                return function (c, e) {
                                    ...
                                    try {
                                        var l = p()({}, k.options), B = f.split("//").pop(),
                                            n = g === l.counterId, q = B === m.location.host,
                ...
                (function (b) {
                    (function (b, c) {
                        ...
                        function n() {
                            var a = 0, b = new W(p), c = t.createTextNode("");
                        ...
                        function w(a, b) {
                            if (a === b) D(a, new TypeError("You cannot resolve a promise with itself")); else {
                                var c = typeof b;
                        ...
                        function J(b, c, e, d) {
                            var k = a(e), g = void 0, f = void 0, l = void 0, B = void 0;
                            if (k) {
                                try {
                                    g = e(d)
                                } catch (sa) {
                ...
                (function (b, c) {
                    !function (d) {
                        ...
                        var x = Object.prototype, w = x.hasOwnProperty, y, v = "function" === typeof b ? b : {},
                            A = v.iterator || "@@iterator", D = v.asyncIterator || "@@asyncIterator",
    ...
    var Xb = I.inherit({
        transports: [], globalConfig: D, postParams: [], isDisabled: function () {
    ...
    var Ea = {
        _storage: new ea, globalConfig: null, key: "zzlc", userInfo: "", updateInfo: function (a) {
        ...
        getInfoFlags: function () {
            ...
            var b = x.isFF(68);
            var c = this;
            this.getZZ() || this.checkVersion() && !b || (b && (a = "md"), b = h.getNativeFunction("createElement", t)("iframe"), b.style.display = "none", b.style.width = "1px", b.style.height = "1px", b.style.visibility = "hidden", b.src = "https://mc.yandex." + a + na.decode("L21ldHJpa2EvenpsYy5odG1s"), m.document.documentElement.appendChild(b), y.on(m, "message", this.onMessage, this, {passive: !1}), this.frame = b, this.timeout = h.setTimeout(function () {
                y.un(m, "message", c.onMessage, c, {passive: !1});
    ...
    U.initCookie = function (a) {
        var b = new T({onlyCurrentDomain: "uid" !== a}), c = b.read(a), d = U._storage.get(a), f = !1, l = b.read("d"),
            g =
                v.getSeconds();
    ...
    x.getFlashVersion = h.memorize(function () {
        ...
        if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
            ...
            var c = b.version;
            if ((b = b.description) ||
                c) if (a = a.mimeTypes, "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin) c ? x._flashVersion = c : b && (x._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/, "."))
    ...
    x.getFingerPrint = h.memorize(function () {
        ...
        if (navigator.mimeTypes && navigator.mimeTypes.length) for (b =
    ...
    var Qa = U.inherit({
        ...
        getFu: function (a, b) {
            var c = a !== L().href, d = t.referrer.replace(/\/$/, ""), f = (b || "").replace(/\/$/, "");
            d = d !== f;
            f = 0;
            d && c ? f = 3 : d ? f = 1 : c && (f = 2);
            return f
    ...
    var Ja = I.inherit({
        sampling: 1, counterId: 26302566, _initComponent: function () {
            ...
            this._sender = new Qa({protocol: "https:", counterId: this.counterId, retry: !1, counter: {}})
        }, log: function () {
        ...
        resource: "webvisor", retry: !0, postParams: ["wv-data"], sendPacket: function (a, b, c, d, f, l, g, n) {
            ...
            if (0 == r.indexOf("AAAAAAAAADw") && m.Error) {
                var u = Error();
                "string" == typeof u.stack && (new Ja({sampling: .1})).log("bad visor packet 5",
                    1)
            }
            a = {
                rn: h.random(),
    ...
    w.getFormNumber = function (a) {
        var b = t.getElementsByTagName("form"), c;
        var d = 0;
        ...
        if (wb) {
            var jb = function (a) {
                ...
                return b.aa = a, b.W = c, b.o = function (a, c, l) {
                    b.D(a, c) || Object.defineProperty(a, c, {enumerable: !0, get: l})
                }, b.C = function (a) {
                    "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(a, Symbol.toStringTag, {value: "Module"});
                    Object.defineProperty(a, "__esModule", {value: !0})
                }, b.$ = function (a, c) {
                    ...
                    if (b.C(d), Object.defineProperty(d, "default",
                        {
                            enumerable: !0,
                            value: a
                        }), 2 & c && "string" != typeof a) for (var g in a) b.o(d, g, function (b) {
                        return a[b]
                    }.bind(null, g));
                    return d
                }, b.X = function (a) {
                ...
                var d = this && this.U || function () {
                    return (d = Object.assign || function (a) {
                        for (var b, c = 1, d = arguments.length; c < d; c++) for (var k in b = arguments[c]) Object.prototype.hasOwnProperty.call(b,
                            k) && (a[k] = b[k]);
                        return a
                    }).apply(this, arguments)
                };
                b.a = !0;
                var f = c(1), l = c(2), g = c(4), n = c(5), h = c(6);
                a = function () {
                    function a(a) {
                        var b = this;
                        this.l = a;
                        this.H = {webGL: f.B, dnt: n.w, plugins: l.A, applePay: g.v};
    ...
    !ib(/webkit/) && ib(/gecko/);
    var mb = {
            asyncChunk: 400, maxDuration: 20, restTime: 100, asyncBuffer: [], timeout: null,
            rest: 0, addAsyncItem: function (a, b, c, d, f) {
                var l = this;
        ...
        fc = Wa.inherit({
            ...
            sendPacket: function (a, b, c, d, f, l, g, n, r) {
                ...
                f = {et: g, w: u[0] + "x" + u[1], v: this._getVersion(), z: f, i: l};
            ...
            addData: function (a, b, c, d, f) {
                ...
                if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit) if (this._v = c, this.wrappers.length && h.arrayEvery(this.wrappers, function (c) {
                    ...
                    c = R.stringify(b);
                    f = this._getSize(c);
                    if (f > this.maxBufferSize) for (this._data.length &&
                                                     this._flush(), d = Math.ceil(c.length / r); l < c.length;) n.partNum = g, n.end = g === d, n.data = c.slice(l, l += r), g++, this._getSize(n.data), this.append([n], !0); else n.data = c, this.append([n], d);
    ...
    try {
        J = function (a) {
            ...
            function l() {
                ...
                if (128 > this.buf[this.pos++]) return a;
                b = 0;
                if (4 < this.len - this.pos) for (; 5 > b; ++b) {
            ...
            a.exports = f;
            var r, u = c(0), p = u.LongBits, m = u.utf8, q, k = "undefined" != typeof Uint8Array ? function (a) {
            ...
            function d(a) {
                "undefined" != typeof Float32Array ? function () {
                    ...
                    var k = new Float32Array([-0]), e = new Uint8Array(k.buffer), g = 128 === e[3];
                    ...
                    function b(a, b, c, e) {
                        ...
                        d && (b = -b);
                        if (0 === b) a(0 < 1 /
                        b ? 0 : 2147483648, c, e); else if (isNaN(b)) a(2143289344, c, e); else if (3.4028234663852886e+38 < b) a((d << 31 | 2139095040) >>> 0, c, e); else if (1.1754943508222875e-38 > b) a((d << 31 | Math.round(b / 1.401298464324817e-45)) >>> 0, c, e); else {
                ...
                "undefined" != typeof Float64Array ? function () {
                    ...
                    function b(a, b, c, e, d, f) {
                        var k = 0 > e ? 1 : 0;
                        k && (e = -e);
                        if (0 === e) a(0, d, f + b), a(0 < 1 / e ? 0 : 2147483648, d, f + c); else if (isNaN(e)) a(0, d, f + b), a(2146959360, d, f + c); else if (1.7976931348623157e+308 < e) a(0, d, f + b), a((k << 31 | 2146435072) >>> 0, d, f + c); else if (2.2250738585072014e-308 >
                            e) e /= 5e-324, a(e >>> 0, d, f + b), a((k << 31 | e / 4294967296) >>> 0, d, f + c); else {
                                ...
                                a.proto = function () {
                                    ...
                                    a.BufferWrapper = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            b || (b = f.create());
                                            if (null != a.buffer && a.buffer.length) for (var c = 0; c < a.buffer.length; ++c) g.ru.yandex.metrika.wv2.proto.Buffer.encode(a.buffer[c], b.uint32(10).fork()).ldelim();
                                            return b
                                        };
                                        ...
                                        a.Meta = function () {
                                            ...
                                            a.encode =
                                                function (a, b) {
                                                    ...
                                                    if (null != a.initialScroll && a.initialScroll.length) for (var c = 0; c < a.initialScroll.length; ++c) g.ru.yandex.metrika.wv2.proto.Page.Scroll.encode(a.initialScroll[c], b.uint32(90).fork()).ldelim();
                                                    return b
                                                };
                                            a.decode = function (a, b) {
                                                a instanceof d || (a = d.create(a));
                                    ...
                                    a.Mutation = function () {
                                        ...
                                        a.AttributeChange = function () {
                                            ...
                                            a.encode = function (a, b) {
                                                b || (b = f.create());
                                                null != a.id && Object.hasOwnProperty.call(a, "id") && b.uint32(8).int32(a.id);
                                                if (null != a.at && Object.hasOwnProperty.call(a, "at")) for (var c = Object.keys(a.at), d = 0; d < c.length; ++d) b.uint32(18).fork().uint32(10).string(c[d]), g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.encode(a.at[c[d]],
    ...
    var Bb = Va.inherit({
        ...
        sendEncoded: function (a, b, c, d, f) {
            var h = this._getSize(a), g = this.getFlushSize(), n = 0, m = 0, u = 1;
            c.size = h;
    ...
    var ob = bb.inherit({
        ...
        _extractElementByHashedUrl: function (a) {
            var b, c;
            try {
                if (b = h.parseUrl(a).hash) if (c = E.selectOne(t.body, b)) return c
            } catch (d) {
                return null
            }
        },
        ...
        id: "o", fields: {
            ...
            var a = [t.head], b = E.select(t.body, 'meta[property\x3d"og:type"]');
    ...
    var kc = wa.inherit({
        ...
        index: 6, request: function (a, b, c, d) {
            var f = !1, l = h.getNativeFunction("createElement", t)("script");
            this.timeout && h.setTimeout(function () {
        ...
        baseUrl: "mc.yandex.", globalConfig: D, baseTld: "ru", partners: {
        ...
        xa = I.inherit({
            globalKey: "f1", MAX_SIZE: 1E6, isYAN: !1, trigger: function (a) {
                ...
                var a = this._sender, b = [], c = (x.getLanguage() || "").toLowerCase().split("-")[0],
                    ...
                    g = f.read("yaGdprCheck"), n = this, r = this.globalConfig.get(this.globalKey), u = arguments;
                b.size = 0;
                ...
                a.hit(function (a) {
                    ...
                    } else n.askGDPR(l, d, c, u, b, f); else return a.params.eu ? n.trigger("GDPR-skip-eu-na") : (f.create("gdpr", "0"), n.trigger("GDPR-eu-skip")), n.realise(u, b)
                })
            }
        });
    xa.globalKey = "f1";
    ...
    var sc = U.inherit({
        ...
        ASSESSOR_COOKIE: "assessor", REMOTE_CONTROL: "i", getInjectHash: function () {
            ...
            var b = h.getNativeFunction("createElement", t)("div"), c = w.getBody() || t.documentElement;
            if (c) {
    ...
    F(function () {
        (function (a) {
            ...
            0: function (a, b, c) {
                ...
                b.__esModule = !0;
                var d =
                    c(5), f = c(9), h = c(34), g = c(6), n = t.body, r = t.documentElement;
                b.detectAd = function () {
                    var a = m.pageYOffset || r.scrollTop || n.scrollTop,
                        ...
                        e = r.scrollHeight || r.offsetHeight || m.innerHeight, t = g.getFrienlyWindowsTree(m), w = [];
                    ...
                    y.forEach(function (d) {
                        ...
                        var m = f.clientWidth;
                        f = f.clientHeight;
                        var n = g + m, q = h + f, p = 0 > g ? 0 : g < k ? g : k, r = 0 > h ? 0 : h < e ? h : e;
                ...
                b.getAdsInWindow = function (a, b) {
                    ...
                    var g = b.isInIFrame, h = a.document.body, l = d.listToArray(h.querySelectorAll("img")),
                        ...
                        e = [], t = [], w = d.listToArray(h.querySelectorAll("yatag")),
                    ...
                    return {adElements: e, iframeProviders: t}
                }
            }
        })
    }, "", !0)();
    ...
    m.Ya[oa] = function (a, b, c, d) {
        ...
        return F(function () {
            ...
            function p() {
                            ...
                            callback: function (k, q) {
                                ...
                                if (!f.isDestructing()) {
                                    ...
                                    if (u) {
                                        b:{
                                            ...
                                            if (aa && aa.length) for (ka = 0; ka < aa.length; ka++) {
                                                ...
                                                if ("ref" == w.type) w = l(w); else if ("adv" == w.type) {
                                                    ...
                                                    var Ha = t.referrer, Aa = Ca.parse(M.search),
                                                    ...
                                                    if (!v && !x.yandex_direct && C && C.length) for (B = 0; B < C.length; B++) if ((new RegExp(C[B], "i")).test(Ha)) {
                                                        v = !0;
                                                        break
                                                    }
                                        ...
                                        aa = p.read("mp2_track");
                                        u = u.substs && u.substs[aa];
                                        aa && u ? (p.create("mp2_substs",
                ...
                q(!1);
                y.on(t, "click", k, null, {name: "extLinkClick"});
            ...
            function C(a) {
                var b =
                    new xa({frameConnector: P, globalConfig: D, initCounter: p, disable: N.yaDisableGDPR});
            ...
            function k(a) {
                if (f._trackLinks && f._trackLinks.on) {
                    a = x.findTarget(a);
                    var b = x.getLinkComponents(a), c = b.href, d = D.get("pai", h.noop)();
            ...
            function E(b) {
                var c = N.referrer ? Y : t.referrer, d = N.url ? O : L().href;
            ...
            if (!m["disableYaCounter" + a]) {
                ...
                f.destruct = u(function () {
                    f._isDestructing = !0;
                    y.un(t, "click", k, null, {name: "extLinkClick"});
                ...
                if (a) {
                    ...
                    if ("prerender" === t.webkitVisibilityState || "prerender" === t.visibilityState) {
                        K.sendPrerenderHit({
                            url: O,
                            vParams: b, title: w.getDocumentTitle(), referrer: t.referrer
                        });
                        var la = function () {
    ...
    (function () {
        ...
        if ("object" == typeof f) {
            var g = f.length;
            for (d = 0; d < g; d++) if (h = f[d]) f[d] = null, h()
        }
        a(b);
        a(c)
    })();
