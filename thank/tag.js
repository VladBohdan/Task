(function (m, u, A) {
    ...
    function Ob(a, b, c, d, f) {
        ...
        function B(a) {
            if (!a.nodeName) return a[V] =
                -1, null;
            var e = +a[V];
            if (!isFinite(e) || 0 >= e) return null;
            if (a.attributes) for (var b = a; b;) {
                if (b.attributes.__ym_wv_ign) return null;
                b = b.parentElement
            }
            b = 64;
            var c = 0, k = w.getElementParent(a), d = k && k[V] ? k[V] : 0;
            0 > d && (d = 0);
            var f = a.nodeName.toUpperCase(), q = Fa[f];
            q || (b |= 2);
            var D = w.getElementNeighborPosition(a);
            D || (b |= 4);
            var p = w.getElementRegion(a);
            (k = k ? w.getElementRegion(k) : null) && p[0] == k[0] && p[1] == k[1] && p[2] == k[2] && p[3] == k[3] && (b |= 8);
            Ka[e].pos = p[0] + "x" + p[1];
            Ka[e].size = p[2] + "x" + p[3];
            a.id && "string" == typeof a.id &&
            (b |= 32);
            (k = w.calcTextChecksum(a)) && (b |= 16);
            var B = w.calcAttribChecksum(a);
            B && (c |= 2);
            a:{
                var z = w.getElementChildren(w.getElementParent(a), a.tagName);
                for (var H = 0; H < z.length; H++) if ((!z[H].id || "string" != typeof z[H].id) && w.calcAttribChecksum(z[H]) == B && w.calcTextChecksum(z[H]) == k) {
                    z = !0;
                    break a
                }
                z = !1
            ...
            q ? g(z, q) : t(z, f);
            D && r(z, D);
            b & 8 || (r(z, p[0]), r(z, p[1]), r(z, p[2]), r(z, p[3]));
            b & 32 && t(z, a.id);
            k && l(z, k);
            b & 1 && l(z, h);
            g(z, c);
        ...
        function q(a, e, b, c, k, d) {
            ...
            var q = {mousemove: 2, click: 32, dblclick: 33, mousedown: 4, mouseup: 30, touch: 12}[e];
            if (!q) return null;
            var p = w.getElementXY(b);
            b = [];
        ...
        function e(a, e) {
            var b;
            if (0 == e.length) var c = b = ""; else 100 >= e.length ? (b = e, c = "") : 200 >= e.length ? (b = e.substr(0, 100), c = e.substr(100)) : (b = e.substr(0, 97), c = e.substr(e.length - 97));
            var k = [];
        ...
        function Ma(a, e) {
            var b = e[V];
            if (0 < b) {
                var c = [], k = w.getElementRegion(e), d = Ka[b], g = k[0] + "x" + k[1], f = k[2] + "x" + k[3];
                if (g != d.pos) {
                    d.pos = g;
        ...
        function N(a) {
            ...
            for (var k = -1, d = a.form.elements, g = d.length, f = 0, q = 0; f < g; f++) if (d[f].name ==
                a.name) {
                if (d[f] == a) {
                    k = q;
                    break
        ...
        function fb(a, e) {
            ...
            if (0 > b) return null;
            for (var c = e.elements, k = c.length, d = [], g = 0; g < k; g++) if (!w.isEmptyField(c[g])) {
                var f = c[g][V];
        ...
        function va(a) {
            ...
            if (e && "SCROLLBAR" != e.nodeName) {
                if (/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e.tagName)) if (e[V]) x(e);
                else {
                    var b = e.form;
                    if (b) {
                        b = b.elements;
        ...
        function W() {
            if (m.getSelection) {
                ...
                var b = a.toString();
                var c = a.anchorNode
            } else u.selection && u.selection.createRange && (a = u.selection.createRange(), b = a.text, c = a.parentElement());
            if ("string" == typeof b) {
                try {
        ...
        function Z() {
            Oa || (Oa = !0, Na && da(D, [v.nowEventTime()]), h.setTimeout(function () {
                Oa = !1
            }, 1, "fvl.copy"))
        }
        ...
        function G(a) {
            (a = X.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (x(a), da(Ta, [v.nowEventTime(), a]))
        }

        function J(a) {
            if ((a = X.getTarget(a)) && !ra(a) && !ma(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
                var e = ba(a), b = /^(checkbox|radio)$/.test(a.type) ? a.checked : a.value;
        ...
        var Q = new sb({
            ...
            globalConfig: f,
            counterType: c,
            meta: {url: L().href, hitId: d, timezone: gb, timestamp: hb}
        }), Fa = {
            A: 1,
            ABBR: 2,
            ACRONYM: 3,
            ...
            VAR: 91,
            NOINDEX: 100
        }, ja = [17, 18, 38, 32, 39, 15, 11, 7, 1], la = function () {
        ...
        }(), aa = 1, ka = /^(password|passwd|pswd)$/, Ha = !0, Aa = !1, Na = "", Oa = !1, sa = !0;
        v.initCorrector();
        v.nowTime();
        var V = "metrikaId_" + Math.random(), Ka = {}, Ua = ":submit" + Math.random();
        if (!h.isMetrikaPlayer()) {
            y.on(u, "click,dblclick,mousedown", va);
            y.on(u, "mouseup", Ga);
            y.on(u, "keydown", Y);
            y.on(u, "keypress", fa);
            y.on(u, "copy", Z);
            if (w.getBody()) y.on(u, "mouseleave", I);
            u.attachEvent && !m.opera ? (y.on(u, "focusin", E), y.on(u,
                "focusout", K)) : (y.on(m, "focus", P), y.on(m, "blur", C), y.on(u, "blur", C));
            u.addEventListener ? (y.on(u, "focus", F), y.on(u, "blur", G), y.on(u, "change", J), y.on(u, "submit", M)) : u.attachEvent && (y.on(u, "focusin", F), y.on(u, "focusout", G), function () {
                for (var a = u.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                    for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++) if (/^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName)) y.on(b[c], "change", J);
                    y.on(a[e], "submit", M)
                }
            }());
            (function () {
                var a = u.getElementsByTagName("form");
                if (a.length) for (var e =
                    0; e < a.length; e++) {
                    var b = a[e].submit;
        ...
        return {
            start: function () {
                ...
                u.removeEventListener ?
                    (y.un(u, "focus", F), y.un(u, "blur", G), y.un(u, "change", J), y.un(u, "submit", M)) : u.detachEvent && (y.un(u, "focusin", F), y.un(u, "focusout", G), function () {
                    for (var a = u.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                ...
                (function () {
                    for (var a = u.getElementsByTagName("form"), e = 0; e < a.length; e++) a[e][Ua] && (a[e].submit = a[e][Ua])
                })()
            }
        }
    }
    ...
    function vb() {
        var a = m.performance || m.webkitPerformance, b = a && a.timing, c, d = [];
    ...
    function Tb(a) {
        var b = [], c = a._lastPerformanceTiming, d = vb(), f;
        if (c) {
            var l = 0;
    ...
    var Pa = !1, wb = "undefined" !== typeof Object && "function" === typeof Object.defineProperty;
    try {
        if (wb) var Wb = function (a) {
            ...
            b.d = function (a, c, l) {
                b.o(a,
                    c) || Object.defineProperty(a, c, {enumerable: !0, get: l})
            };
            b.r = function (a) {
            ...
            b.t = function (a, c) {
                ...
                if (c & 2 && "string" != typeof a) for (var g in a) b.d(d, g, function (b) {
                    return a[b]
                }.bind(null, g));
                return d
            };
            ...
            var d = c(29), f = c(20), l = c(27), g = c(8), n = c(12);
            a = c(9);
            var r = c(2), t = a.a.Map, p = a.a.Set, B = {
                binarySearch: function (a, b, e) {
                    var c = 0, k = a.length - 1;
                    ...
                    return a instanceof g.List || a instanceof n.KeyValue ? p && a instanceof p || t && a instanceof t ? Object(l.a)(a) : a.toArray() : Object(l.a)(a)
                }, toList: function (a) {
                    ...
                    for (var c = a.length; e < c; e++) if (a[e] === b) return !0;
                    return !1
                }
            }
        }, function (a, b) {
            ...
            c.r(b);
            a = c(5);
            var d = c.n(a), f = c(9), l = f.a.Object.assign || function (a) {
                for (var b = 1; b < arguments.length; b++) {
                    var c = arguments[b], d = f.a.Object.prototype.hasOwnProperty.bind(c), g;
            ...
            var n = {
                assign: function (a) {
                    ...
                    for (var c = b.split("."), d = a, g = 0, k = c.length; g < k; g++) if (d = d[c[g]], null == d) return A;
                    return d
            ...
            "undefined" === g.a.WV_DEBUG && Object.defineProperty(g.a, "WV_DEBUG", {value: {}});
            var t = function () {
                var a = !1, b = !1;
                ...
                __native: r, __debugMode: t,
                __addDebug: function (a, b) {
                }, devLog: function () {
                }
            }, B = ["%cWV:", "font-weight: bold;"];
            c && B.length && (B[1] += "color: purple");
            Object(a.a)(r, function (a) {
                var b, e = r[a] instanceof n.a.Function;
                p[a] = t ? e ? (b = r[a]).bind.apply(b, [r].concat(B)) : r[a] : e ? function () {
                } : r[a]
            }, !0);
            t && (p.devLog = r.log);
            b["default"] = p
            ...
            a = c(13);
            var f = c(4);
            c = d()({}, c(28).BrowserUtils, c(36).DocumentUtils, c(10).DOMUtils, c(23).FunctionUtils, c(0).IterableUtils, c(89).MapUtils, c(2).ObjectUtils, c(19).StringUtils, c(37).TimeUtils, c(16).Tools, {math: c(90).MathUtils});
            try {
            ...
            Object.defineProperties(c, {
                DO_NOT_TRACK: {value: l},
                IS_INCOGNITO: {value: g},
                IS_MOBILE_DEVICE: {value: n},
                IS_DEVELOPMENT: {value: r}
            });
            b["default"] = c
        }, function (a, b, c) {
            c.r(b);
            ...
            var n = function () {
                ...
                b.each = function (a) {
                    if ("function" ===
                        typeof a) for (var b = 0; b < this.list.length;) {
                        var c = this.list[b];
            ...
            b.a = function () {
                ...
                if ("undefined" !== typeof u && u.body) {
                    ...
                    try {
                        /Trident|MSIE/.test(navigator.userAgent) ? u.body.parentNode && u.body.parentNode.appendChild(b) : u.body.appendChild(b), f(b, ["Set", "Map"]) && (a = b.contentWindow || a)
                    } catch (n) {
            ...
            var d =
                ...
                NodeTypes: {
                    ...
                    a.href = "/";
                    var b = u.querySelector("base");
                    b && b.href && (a.href = b.href);
                    return a.href
                }, getScroll: function (a) {
                    if (null == a) return {left: 0, top: 0};
                    if (a.window === a) return {
                        top: a.scrollY || 0, left: a.scrollX ||
                            0
                    };
                    var b = a.ownerDocument || a, c = a.documentElement, d = b.defaultView || b.parentWindow,
                        g = b.body;
                    ...
                    if ("undefined" !== typeof u) {
                        var a = "undefined" !== typeof u.msHidden ? "msHidden" : "undefined" !== typeof u.webkitHidden ? "webkitHidden" : "hidden";
                        return function () {
                            return u[a]
                        }
                    }
                    ...
                    var c = a.getAttribute("src"), d = a.getAttribute("sandbox");
                    ...
                    var c = a.ownerDocument ? a.ownerDocument.defaultView : m, d = {
                        stopped: !1, height: null, width: null, runner: function () {
                            if (!this.stopped) {
                                var d = null == a ? {} : "function" === typeof a ? a() || {} : a;
                    ...
                    d = [];
                    for (var g = [], k; (k = c.elementFromPoint(a, b)) && -1 === d.indexOf(k);) {
                        d.push(k);
                        var e = k.style;
                        g.push({
                    ...
                    var c = void 0 === b ? {} : b, d = c.excludeBorder, g = void 0 === d ? !1 : d;
                    c = c.excludePadding;
                    var k = void 0 === c ? !1 : c;
                    !1 === "getBoundingClientRect" in a && ("documentElement" in a ? a = a.documentElement : "document" in a && (a = a.document.documentElement));
                    var e = (a.ownerDocument || u).defaultView || m, f = a.getBoundingClientRect();
                    c = f.top;
                    d = f.right;
                    var l = f.bottom;
                    f = f.left;
                    if (g || k) {
                        ...
                        if (g) {
                            ...
                            var n = e.borderBottomWidth, r = e.borderLeftWidth;
                            c += parseInt(e.borderTopWidth || "0", 10);
                            d += parseInt(g || "0", 10);
                            l += parseInt(n || "0", 10);
                            f += parseInt(r || "0", 10)
                        }
                        k && (k = e.paddingRight, g = e.paddingBottom, n = e.paddingLeft, c += parseInt(e.paddingTop || "0", 10), d += parseInt(k || "0", 10), l += parseInt(g || "0", 10), f += parseInt(n || "0", 10))
                    }
                    return {top: c, right: d, bottom: l, left: f}
                    ...
                    if (d.nodeIsInTree(a)) b(!0); else {
                        var k = a.ownerDocument || u, e = new MutationObserver(function () {
                            d.nodeIsInTree(a) && (b(!0), e.disconnect())
                        });
                        e.observe(k.documentElement, {subtree: !0, childList: !0});
                    ...
                    f.IterableUtils.forof(a.attributes, function (c) {
                        try {
                            ...
                            d.a.console.warn("Can't copy attribute [" +
                                c.name + "\x3d" + c.value + "]", {sourceNode: a})
                        }
                    });
                    return b
            ...
            var f = c.n(a);
            a = c(13);
            var l = c(2), g = c(0), n = c(10), r = c(16), t = c(3);
            c = a.a.DOMIndexer;
            var p = c.IGNORED_NODES, B = c.IGNORED_ATTRIBUTES, q = c.SKIPPED_ATTRIBUTES, k = c.EXTRA_ATTRIBUTES, e = [],
                D = {}, H = {
                    INPUT: function (a, b) {
                        var e = f()({}, b);
                    ...
                    if (a.childNodes && 0 < a.childNodes.length) {
                        c = a.childNodes;
                        for (var k = 0, d = c.length; k < d; k++) e.push.apply(e, ba(c[k]))
                    }
                    return e
                }, m = function (a, b, e) {
                    var c = function (a) {
                    ...
                    if ("function" === typeof b && c(a) === NodeFilter.FILTER_ACCEPT &&
                        (b(a), !1 === z(a))) for (a = u.createTreeWalker(a, -1, e ? {acceptNode: c} : null, !1); a.nextNode() && !1 !== b(a.currentNode);) ;
                }, La = function (a, b) {
                    var e = [];
                    a && (n.DOMUtils.nodeIsInTree(a) ? m(null == a ? u.documentElement : a, function (a) {
                        e.push(a)
                    }, b) : e.push.apply(e, h(a, b)));
                    return e
                }, Ma = function (a) {
                    var b = a["*"], e = d()(a, ["*"]), c = {}, k = new RegExp(b.join("|"), "i");
                    ...
                    for (var c = 0, k = N.length; c < k; c++) if (!0 === N[c](a, b, e)) return !1;
                    return !0
                }, da = function (a, b, c) {
                    var k = c;
                    if (fb(a, b, c)) {
                        k = e.reduce(function (e, c) {
                            try {
                                ...
                                return t["default"].warn("Filtering error",
                                    W), e
                            }
                        }, k);
                        if ("string" === typeof k) return (c = D[b]) ? c(a, b, k) || k : k;
                    ...
                    if (e && e.name) {
                        if (!1 !== x(b, e.name)) try {
                            ...
                            t["default"].warn("Error while reading attribute", e, a), t["default"].warn(Y)
                        }
                    } else t["default"].warn("Error while reading attribute", e, a);
                    return null
                };
            c = function (a) {
                var b =
            ...
            c = {
                ...
                getAttributes: function (a) {
                    var b = {}, e = a.nodeName, c = g.IterableUtils.toArray(a.attributes);
                ...
                cloneAttributes: function (a, b) {
                    ...
                    g.IterableUtils.fastIterate(e, function (a, e) {
                        var c = !1 === r.Tools.isNULL(e.namespaceURI), k = e.cloneNode();
            ...
            var n = function () {
                ...
                b.set = function (a, b) {
                    var c = this.indexOf(this.index, a);
                    -1 !== c ? this.list[c].value = b : (this.list[this.lastIndex] = {
                        key: a,
                        value: b
                ...
                b["delete"] = function (a) {
                    if (a = this.find(a)) if (a = this.indexOf(this.list, a), -1 !== a) return this.list.splice(a, 1), this.index.splice(a, 1), this.lastIndex--, !0;
                    return !1
                };
                b.each = function (a) {
                ...
                b.loop = function (a) {
                    if ("function" === typeof a) for (var b = 0; b < this.list.length;) a.call(this, this.list[b]), b++
                };
                b.create = function (a) {
                    var b = 0;
                    if (a && 0 < a.length) for (; b < a.length;) {
                        var c = a[b];
                        this.set(c[0], c[1]);
                        b++
                    }
            ...
            var d = a()({}, {NATIVE_IFRAME_NAME: "ym-native-frame"}, {
            ...
            (function (a, f) {
                var d = c(8), g = c(0), n = c(2), r = function () {
                    function b(b, c) {
                        var k = void 0 === c ? {} : c, e = k.context;
                        e = void 0 === e ? null : e;
                        k = k.expose;
                        k = void 0 === k ? !1 : k;
                    ...
                    c._define = function (a, b) {
                        Object.defineProperty(this, a, {value: b, writable: !1});
                        return this
                    };
                    ...
                    c._saveNamespace = function (b, c, k) {
                        var e = this._namespaces.get(b) || new a, g = e.get(c || "__global") || new d["default"];
                        g.add(k);
                        e.set(c || "__global", g);
                    ...
                    c._removeNamespace = function (a, b) {
                        var c = this, e = this._namespaces.get(a);
            ...
            (function (a) {
                ...
                var d = c(4), l = c(40), g = c(2), n = c(3), r = {"null": null, undefined: A, "true": !0, "false": !1},
                    t = {
                        delay: function (b, c) {
                            void 0 ===
                            c && (c = 0);
                            ...
                            return new a(function (a) {
                                var c = u.createElement("textarea"), k = u.body;
                                c.value = b;
                                c.style.opacity = "0";
                                ...
                                c.onselect = function () {
                                    try {
                                        c.onselect = null, u.execCommand && u.execCommand("copy"), a()
                                    } catch (e) {
                            ...
                            try {
                                ...
                                return n["default"].warn(B), B
                            }
                        }, fetch: l.a, promise: function (b) {
            ...
            a = c(13);
            b = c(12);
            var d = c(10), f = c(19), l = new b.KeyValue, g = String.fromCharCode(8226);
            a = a.a.captorsConfig.input.PD();
            c = a.suspiciousWords;
            a = a.placeholderSuspiciousWords;
            var n = new RegExp("(" + c.join("|") + ")", "i"), r = new RegExp("(" + c.concat(a).join("|") +
                ")", "i"),
                t = /color|radio|checkbox|date|datetime-local|email|month|number|password|range|search|tel|text|time|url|week/i,
                p = {
                    isValidType: function (a) {
                        ...
                        var c = b || {}, e = c.isEU, d = c.recording.keysMode;
                        c = p.isRecordable(a);
                        var g = p.isPrivateInformationField(a);
                        e = p.isAllowed(a, "explicit" === d) && (!e || !g);
                        return {forceRecord: c, isPrivate: g, isAllowed: e}
                    }, encode: function (a) {
                        void 0 === a && (a = "");
            ...
            var d = c(4), f = c(0), l = {
                dasherize: function (a) {
                    ...
                    if (b) {
                        ...
                        var g = c[1], f = c[2];
                        c = c[3];
                        var l = g ? (g.match(/([^:\s]+)(:[0-9]*)?/) || []).slice(1) : [], q = l[0];
                        q = void 0 === q ? A : q;
                        l = l[1];
                        l = void 0 === l ? A : l;
                        var k = q ? (q.match(/\.([^.]+)$/) || [])[1] : A, e = f ? function () {
                            var a = f.match(/([^/]+)\.([^/]*)$/);
                            return a ? a[0] : A
                        }() : A, D = f && e ? f.replace("/" + e, "") : f || "/";
                        return {
                            protocol: b ? b + ":" : A,
                            hostname: g,
                            host: q,
            ...
            b.a = function (a, b, c) {
                void 0 === c && (c = !1);
                var d = 2 === b.length;
                if (a && b instanceof Function) for (var f in a) if (a.hasOwnProperty(f) || !0 === c) {
                    var l = d ? b(f, a[f]) : b(f);
                    if (!0 !== l && !1 === l) break
                }
            }
            ...
            (function (a, c) {
                var d = new a;
                b.a = {
                    throttledFunctions: d, invokeAll: function (a) {
                        c.fastIterate(d, function (b, c) {
                            c.invoke.call(a)
                        })
                    },
                    create: function (a, b) {
                        var g = void 0 === b ? {} : b, f = g.timeout, l = void 0 === f ? 0 : f;
                        f = g.immediateFirstRun;
                        var n = void 0 === f ? !1 : f;
                        g = g.context;
                        var q = !0, k = null, e = null, D = null, H = null, z = !1, h = null, m = null;
                        g = {
                            invoke: function () {
                                var b = this.context || this;
                                D !== k && (H = c.now(), D = k, a.call(b, {
                                    object: k,
                                    prevObject: null,
                                    timeDifff: 0,
                                    args: m
                                ...
                                if (!z) {
                                    k = b;
                                    for (var g = arguments.length, f = Array(1 < g ? g - 1 : 0), t = 1; t < g; t++) f[t - 1] = arguments[t];
                                    m = f;
                                    q && n ?
                                        (q = !1, D = b, a.call(d, {
                                            object: b,
                                            ...
                                            b >= l ? (z = !1, H = c.now(), D !== k && (e = D, D = k, a.call(d, {
                                                object: k,
                                                prevObject: e,
                                                timeDiff: b,
                                                args: m
                            ...
                            }, context: void 0 === g ? null : g, call: function () {
                                var a;
            ...
            var d = {
                invoke: function (a, b, c) {
                    ...
                    var c = void 0 === b ? {} : b, d = c.context, f = void 0 === d ? null : d;
                    d = c.args;
                    var l = void 0 === d ? [] : d;
                    d = c.delay;
                    var p = void 0 === d ? 0 : d;
                    c = c.raf;
                    c = void 0 === c ? !0 : c;
                    var B = Date.now(), q = !1, k = null, e = c ? this.requestAnimationFrame.bind(this) : G,
                        D = c ? this.cancelAnimationFrame.bind(this) : clearTimeout;
                    c = function z() {
                        q ? D(k) :
                            (Date.now() - B >= p && (B = Date.now(), a.apply(f, l)), k = e(z))
                    };
                    c.stop = function () {
                        q = !0
                    };
            ...
            var d = c(4), f = c(2), l = function () {
                var a = !1;
                if (f.ObjectUtils.objectIsWindow(d.a)) try {
                    d.a.addEventListener("test", function () {
                ...
                b.a = function (b) {
                    ...
                    try {
                        if (b.forEach) b.forEach(function (a, b) {
                            ...
                            b && a && b !== a && (e = [b, a]);
                            c.push(e)
                        }); else for (var p = b[a.iterator](), B, q; B = p.next(), q = B.value, !B.done;) c.push(q);
                        return c
                    } catch (k) {
                        return []
                    }
            ...
            var d = c(4), f = c(10), l = {
                isMSIE: function () {
                    var a = d.a.navigator.userAgent, b = a.indexOf("MSIE ");
                    ...
                    return (a = u.querySelector('meta[name\x3d"ym:' + a + '"]')) ? a.content : null
                }, scaleFactor: function (a, b) {
                    var c = a.clientWidth, d = a.clientHeight,
                    ...
                    null === g && (g = f.DOMUtils.createElement("ym-measure", {
                        className: "ym-zoom",
                        style: {bottom: "100%", position: "fixed", width: "100vw"}
                    }), c(g));
            ...
            (function (a) {
                ...
                b.a = function (b, c) {
                    var g = 2 === c.length;
                    if (b && c instanceof Function) if (null != b[a.iterator]) if (g) if (b instanceof Array) {
                        g = 0;
                        ...
                        if (b[a.iterator]) for (g = b, f = Array.isArray(g), n = 0, g = f ? g : g[a.iterator](); ;) {
                            if (f) {
                                if (n >= g.length) break;
                                var B = g[n++]
                            } else {
                    ...
                    } else for (g = b, f = Array.isArray(g), n = 0, g = f ? g : g[a.iterator](); ;) {
                        if (f) {
                            if (n >= g.length) break;
                            B = g[n++]
                        } else {
                        ...
                        B = c(B);
                        if (!0 !== B && !1 === B) break
                    } else if ("forEach" in b) l(b, c, g); else if (b instanceof Array) for (f = Object(d.a)(b), n = 0; n < f.length && (B = f[n], B = g ? c.apply(void 0, B) : c(B), !0 === B || !1 !== B); n++) ;
                }
            }).call(this, c(25)["default"])
        }, function (a, b, c) {
            (function (a, f, l) {
                ...
                var d = c(1);
                d = c.n(d);
                var n = c(15), r = "2d webgl experimental-webgl webgl2 experimental-webgl2 bitmaprenderer".split(" "),
                    t = function () {
                    ...
                    }(), p = new a, B = HTMLCanvasElement.prototype.getContext, q = function (a) {
                        var b = u.createElement("canvas");
                        b.width = a.width;
                        b.height = a.height;
                        b.proxy = !1;
                ...
                a = function () {
                    ...
                    a.mock = function () {
                        if (!this.mocked) {
                            ...
                            HTMLCanvasElement.prototype.getContext = function (b) {
                                var c = B.call(this, b);
                                if (null !== c) return !1 !== this.proxy && 0 <= t.indexOf(b) && a.update(c), c
                            };
                            var b = u.querySelectorAll("canvas");
                    ...
                    a.remove = function () {
                        this.mocked && (this.mocked = !1, this.events.off(), HTMLCanvasElement.prototype.getContext = B)
                    };
                    a.update = function (b) {
                        if (!1 === a.proxies.has(b)) {
                            var c = this, e = b.canvas, d = Object.getPrototypeOf(b), g = k(b);
                            f.nodeIsRecordable(e) && g.properties && (f.forof(g.properties,
                                function (a) {
                                    var e = Object.getOwnPropertyDescriptor(d, a), k = f.combine(e);
                    ...
                    a.setterInvoked = function (a, b, c) {
                        ...
                        this.mocked && G(function () {
                            e.send(a, "setter", {name: b, value: String(c)})
                        })
                    };
                ...
                d = function () {
                    ...
                    c._executeJob = function (a) {
                        ...
                        try {
                            ...
                            n["default"].log("Error occurred when running job"), n["default"].log(B), n["default"].log(a.toString())
                        }
                        return (new Date).valueOf() - this.jobExecutionStartStamp
                    };
                    l()(b, [{
                        key: "hasJobs", get: function () {
            ...
            (function (b) {
                function c(a, c, d, f, t, p, h) {
                    try {
                        var g = a[p](h), k = g.value
                    } catch (e) {
                        d(e);
                        return
                    }
                    g.done ? c(k) : b.resolve(k).then(f, t)
                }
            ...
            function g() {
                e && D && (e = !1, D.length ? k = D.concat(k) : H = -1, k.length && n())
            }
            ...
            (function (a) {
                var d = c(36), l = c(2), g = c(20);
                b.a = function (b) {
                    var c = l.ObjectUtils.assign({url: "", headers: {}, method: "get", type: "json", data: null}, b);
                    ...
                    return (new a(function (a, b) {
                        var f = new XMLHttpRequest, l = new FileReader;
                            ...
                            4 === f.readyState && (200 <= k && 301 > k ? "css" === c.type ? (k = ((f.getResponseHeader("Content-Type") || "").split("; ").map(function (a) {
                                ...
                                switch (c.type) {
                                    case "json":
                                        return JSON.parse(a);
                                    case "html":
                                        return d.DocumentUtils.initDocument({html: a});
                                    default:
                                        return a
                                }
                            }(f.responseText), a({result: k})) : b(Error(k + " " + f.statusText)))
                        });
            ...
            (function (a, c) {
                ...
                b.a = function (a) {
                    void 0 === a && (a = {});
                    var b = a.getStamp || f, c = a.printLog || r, d = {
                        start: function () {
                            var a = this._getTime();
                            this._initializedAt =
            ...
            (function (a, f) {
                ...
                b.a = function () {
                    ...
                    return {
                        inputs: {}, events: {}, create: function (a) {
                            var d = this;
                            ...
                            if (n.a.isValidNode(a.nativeNode) && "__ym_input_override_test" !== a.nativeNode.getAttribute("class")) {
                                ...
                                this.inputs[c] = {checkable: d, value: b[a]};
                                d = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(b), a) || {};
                                var e = Object.getOwnPropertyDescriptor(b, a) || {}, l = g()({}, d, e);
                                if (f.isNative(l.set, "((set)?(\\s?" + a + ")?)?")) {
                                    var t = this;
                                    try {
                                        Object.defineProperty(b, a, g()({}, l, {
                                            configurable: !0, set: function (a) {
                                                var b = this;
                                                t.recorder.errorLogger(function () {
                                                    t.handleInputValueChange(c, a, b)
                                                }, "inpVC");
                            ...
                            this.recorder.errorLogger(function () {
                                var c = a.target, d = b.recorder.indexer.get(c);
                                if (d) {
                                    var e = d.id;
                            ...
                            var d = this.inputs[a], e = d.checkable;
                            d = d.value;
                            if ((!b || -1 !== ["string", "boolean", "number"].indexOf(typeof b)) && b !== d) {
                                if (e) c =
                                    this.recorder._getEventObject("change", a, {checked: !!b}); else {
                                    var g = n.a.validate(c, this.recorder.options);
                                    d = g.forceRecord;
                                    var f = g.isPrivate;
                                    g = g.isAllowed || d ? b : n.a.encode(b);
                                    c = this.recorder._getEventObject("change", c, {value: g, hidden: f && !d})
                                }
                                this.inputs[a] = {checkable: e, value: b};
                        ...
                        checkInpudDescriptorOverrideAbility: function (a) {
                            ...
                            try {
                                ...
                                var d = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(c), "value") || {},
                                    e = Object.getOwnPropertyDescriptor(c, "value") || {}, f = g()({}, d, e);
            ...
            (function (a, f) {
                ...
                b.a = function () {
                    var b = {
                        ...
                        mouseup: {capture: !0},
                        click: {capture: !0}
                    }, c = new a, l = function (a) {
                        var b = a.object;
                        a = a.args[0];
                        var c = b.type, e = b.target, d = b.clientX;
                        d = void 0 === d ? null : d;
                        b = b.clientY;
                        b = void 0 === b ? null : b;
                        e = this.document.elementFromPoint(d, b) || e;
                        a = this._getEventObject(c, e, {x: d, y: b},
                            a);
                        this._publishActions(a)
                    }, t = d.a.create(l, {timeout: 0}), p = function (a) {
                        var b = this.stamp;
                        "mousemove" === a.type ? t.call(this, a, b) : l.call(this, {object: a, args: [b]})
                    };
                    return {
                        create: function (a) {
            ...
            (function (a, c) {
                b.a = function () {
                    var b = {focus: {capture: !0}, blur: {capture: !0}}, d =
                        new a, f = function (a) {
                ...
                b.a = function () {
                    ...
                    return {
                        getValue: function (a, b) {
                            ...
                            b = a.attachEvent(a.window, "orientationchange", a._universalHandler(c, {extra: [this]}), {passive: !0})
                        }, destroy: function (a) {
                            a.removeEvent(b)
                        }
                    }
            ...
            (function (a, f) {
                ...
                b.a = function () {
                    var b,
                        c = new a, l = function (a) {
                            var b = a.args[0], c = this.viewport.scrollingElement;
                            a = a.object.target;
                            var d = this.document, e = this.window, g = f.getScroll(a);
                            ...
                            var b = a.target;
                            if (c.has(b)) b = c.get(b); else {
                                var g = d.a.create(l, {timeout: f.isAndroid() ? 0 : 100, immediateFirstRun: !0});
                                c.set(b, g);
                                b = g
                            }
                            b.call(this, a)
                    ...
                    return {
                        create: function (a) {
                            var c = a._universalHandler(t);
                            b = a.attachEvent(a.document,
                                "scroll", c.bind(a), {capture: !0, passive: !0})
                        }, destroy: function (a) {
                            a.removeEvent(b);
                            c.clear()
                        }
            ...
            (function (a, f, l) {
                ...
                b.a = function () {
                    ...
                    }, c = new a, g = new f, p = !1, h = function (a) {
                        var b = a.object;
                        a = a.args[0];
                        var c = b.type, e = l.map(b.changedTouches, function (a) {
                            return {id: a.__id, x: Math.round(a.clientX), y: Math.round(a.clientY), force: a.force}
                        });
                        b = this._getEventObject(c, b.target, {touches: e}, a);
                        this._publishActions(b)
                    }, q = d.a.create(h, {timeout: l.isAndroid() ? 0 : 300}), k = function (a) {
                        var b = this.stamp, c = "touchcancel" === a.type || "touchend" === a.type;
                        a.changedTouches && 0 < a.changedTouches.length && l.forof(a.changedTouches, function (a) {
                            var b = void 0 === c ? !1 : c;
                            if (g.has(a.identifier)) var e = g.get(a.identifier); else e = l.guid(), g.set(a.identifier, e);
                            b && g["delete"](a.identifier);
                            a.__id = e
                        });
                        "touchmove" === a.type ? p ? h.call(this, {object: a, args: [b]}) : q.call(this, a, b) :
                            h.call(this, {object: a, args: [b]})
                    };
                    return {
                        create: function (a) {
                            ...
                            var d = null, g = a._universalHandler(function () {
                                clearTimeout(d);
                                p = !0;
                                d = G(function () {
                                    return p = !1
                            ...
                            c.add(a.attachEvent(a.document, "scroll", g, {passive: !0, capture: !0}))
                        }, destroy: function (a) {
            ...
            (function (a, c) {
                b.a =
                    function () {
                        var b = new a, d = [], f = null, r = function () {
                            var a = this, b = this.stamp, g = this.viewport.zoomLevel;
                            if (this.zoomLevel !== g) {
                                clearTimeout(f);
                                var l = c.scrollingElement(), k = l.scrollLeft;
                                l = l.scrollTop;
                                this.zoomLevel = g;
                                d.push([b, g, k, l]);
                                f = G(function () {
                                    var b = d[0], c = d[d.length - 1], k = c[0];
                                    b = a._getEventObject("zoom", 0, {
                                        zoomFrom: {level: b[1], x: b[2], y: b[3]},
                                        zoomTo: {level: c[1], x: c[2], y: c[3]},
                                        duration: k - b[0]
                                    }, k);
                                    d.length = 0;
                                    a._publishActions(b)
            ...
            (function (a, c) {
                b.a = function () {
                    var b, d = "undefined" !== typeof u.hidden ? {
                            hidden: "hidden",
                            event: "visibilitychange"
                        } : "undefined" !== typeof u.msHidden ? {
                            hidden: "msHidden",
                            event: "msvisibilitychange"
                        } : "undefined" !== typeof u.webkitHidden ? {
                            hidden: "webkitHidden",
                            event: "webkitvisibilitychange"
                        } : null,
                        f = d ? (b = {}, b[d.event] = {capture: !0}, b) : {focus: {capture: !0}, blur: {capture: !0}},
                        r = {focus: "windowfocus", blur: "windowblur"},
                        t = new a, p = function (a) {
                            a = d ? this._getEventObject(r[u[d.hidden] ? "blur" : "focus"], this.window) : this._getEventObject(r[a.type], this.window);
                            this._publishActions(a)
                        };
                    return {
                        create: function (a) {
                            ...
                            c.forin(f, function (c) {
                                t.add(a.attachEvent(a.window, c, b, f[c]))
                            })
                        }, destroy: function (a) {
                            c.forof(t, function (b) {
                                return a.removeEvent(b)
                            });
                            t.clear()
                        }
                ...
                d = function (b) {
                    ...
                    e.collectMutations = function (a) {
                        ...
                        this.queue.push(function () {
                            ...
                            c.hasData && b.emit("mutation", {changes: c.store, stamp: a.stamp})
                        })
                    };
                    e.destroy = function () {
                        this.queue.start(!0);
                    ...
                    e.processMutations = function (b) {
                        ...
                        a.fastIterate(b, function (a, b) {
                            if (b.target.parentNode && !h.c.isIgnoredNode(b.target.parentNode)) {
                                ...
                                !1 !== function () {
                                    var a = b.type, e = b.target, d = c.indexer.getIndexedNodeId(e);
                                    if (null == d) return !1;
                                    e = [b, d, e, k];
                                    switch (a) {
                                        case "childList":
                    ...
                    e.processTreeChanges = function (b, c, e, d) {
                        var k = this, g = b.nextSibling, f = b.previousSibling;
                        e = b.meta;
                        b = e.addedNodes;
                        e = e.removedNodes;
                        e = void 0 === e ? [] : e;
                        ...
                        a.fastIterate(void 0 === b ? [] : b, function (b, e) {
                            k.indexer.reindexNodeTree(e, {
                                parentID: c, callback: function (b, c) {
                                    if (b) {
                                        var d =
                                            a.combine({
                                                id: b.id,
                                                pa: b.parent,
                                                nm: b.name
                                            }, c === e ? {pr: k.getIDForNode(f), nx: k.getIDForNode(g)} : {});
                                        b.content && (d.ct = b.content);
                                        b.namespace && (d.ns = b.namespace);
                                        d.at = h.c.getAttributes(b.nativeNode);
                                        l.push(d)
                                    }
                                }
                            })
                        ...
                        if (0 === l.length && 0 === D.length) return !1;
                        this.addChanges.apply(this, [d, "a"].concat(D));
                    ...
                    e.processAttributesChanges =
                        function (a, b, c, e) {
                            ...
                            k = k.newValue;
                            var g = null === k || k === A;
                            this.addChanges(e, "c", {id: b, at: (d = {}, d[a] = {n: k, o: c, r: g}, d)})
                        };
                    e.processContentChanges = function (a, b, c, e) {
                        this.addChanges(e, "d", {id: b, ct: {n: a.meta.newValue, o: a.meta.oldValue}})
                    };
                    ...
                    l()(c, [{
                        key: "changesObject", get: function () {
                            return {a: [], b: [], c: [], d: []}
                        }
                    }, {
                        key: "html",
            ...
            (function (a, f, l) {
                ...
                d = function (b) {
                    ...
                    d.initMutationObserver = function () {
                        var b = this, c = this.document.defaultView.MutationObserver;
                    ...
                    d.processMutations = function (a) {
                        var b = this;
                        a = f.toArray(a);
                        var c = {added: new l, removed: new l};
                        a = f.reduceRight(a, function (a, e) {
                            var d = e.type, k = e.target, g = b.collectSummary(d, k, c, e);
                            null != g && a.unshift({
                                target: k,
                                type: d,
                                meta: g,
                        ...
                        0 < a.length && this.emit("mutation", {summary: a, stamp: this.recorder.stamp});
                        c.added.clear();
                        c.removed.clear()
                    };
                    d.collectSummary = function (a, b, c, d) {
                        switch (a) {
                            case "childList":
                                ...
                                if (0 < b.length || 0 < d.length) return {addedNodes: b, removedNodes: d};
                                break;
                            case "attributes":
                                a = d.attributeName;
                                d = d.oldValue;
                                ...
                                if (d !== e) return {
                                    name: a,
                                    oldValue: p.c.normalizeAttributeValue(b, a, d),
                                    newValue: p.c.normalizeAttributeValue(b, a, e)
                                };
                                break;
                            case "characterData":
                                if (d = d.oldValue, b = b.textContent,
                                b !== d) return {oldValue: d, newValue: b}
                        }
                    };
                    return c
                }(c(15).a);
            ...
            a = function () {
                function a(a,
                    ...
                    void 0 === a && (a = "body");
                    void 0 === b && (b = {});
                    this.root = "string" === typeof a ? u.querySelector(a) : a;
                    this.ctx = b;
                    ...
                    this.keyOrder = {"super": 1, ctrl: 2, alt: 3, shift: 4, tab: 5, "delete": 6, backspace: 6};
                    this.singleKeys = [4, 9, 8, 32, 37, 38, 39, 40, 46];
                    this.keyDict = {
                        macos: {
                            91: "\x26#8984;", 93: "\x26#8984;", 224: "\x26#8984;", 18: "\x26#8997;",
                            17: "\x26#8963;", 16: "\x26#8679;", 9: "\x26#8677;", 8: "\x26#9003;", 46: "\x26#9003;"
                        },
                        other: {
                            91: "\x26#xff;",
                            93: "\x26#xff;",
                ...
                b.getKeystroke = function (a) {
                    var b = this, c = this.keyOrder;
                    return a.map(function (a) {
                        var c = a.keyCode, d = b.modifierCodes[a.keyCode],
                            g = b.getKeySymbol(a);
                        return {id: c, key: b.getKeySymbol(a), isMeta: !!d && /^&#/.test(g), modifier: d}
                    }).sort(function (a, b) {
                ...
                b.keyupHandler = function (a) {
                    if (this.applyFilters(a.target)) {
                        var b = this.isModifier(a.keyCode), c = this.held(a.keyCode);
            ...
            (function (a) {
                var d = c(1), l = c.n(d), g = c(15), n = c(30), r = c(2),
                    t = c(16), p = c(0);
                d = "HTMLMediaElement" in m;
                var h = {}, q = p.IterableUtils.toList(["addEventListener", "removeEventListener"]), k = function () {
                    function b() {
                        l()(this, "originalDescriptors", new a);
                        l()(this, "mocked", !1);
                        l()(this, "events", new g.a(["setter", "method"]));
                        r.ObjectUtils.assign(h, t.Tools.apiMock(HTMLMediaElement))
                    }
                    ...
                    c.mock = function () {
                        var a = this, b = HTMLMediaElement.prototype, c = this;
                        ...
                        p.IterableUtils.forof(h.methods, function (e) {
                            ...
                            Object.defineProperty(b, e, {
                                configurable: !0, value: function () {
                                    for (var a, b = arguments.length, k = Array(b), g = 0; g < b; g++) k[g] = arguments[g];
                    ...
                    c.setterInvoked = function (a, b, c) {
                        var e = this;
                        this.mocked && G(function () {
                            e.send(a, "setter", {name: b, value: c})
                        })
                    };
                    ...
                    c.send = function (a, b, c) {
                        this.events.emit(b, r.ObjectUtils.combine(c, {media: a}))
                    };
                    return b
                }();
                l()(k, "supported", d);
            ...
            (function (a) {
                ...
                var d = function (b, c) {
                    void 0 === c && (c = "body");
                    return new a(function (a) {
                        null == b.querySelector(c) || u.hidden || u.msHidden || u.webkitHidden ? function t() {
                            null == b.querySelector(c) || u.hidden || u.msHidden || u.webkitHidden ? G(t, 100) : a()
                        }() : a()
                    })
                }
            }).call(this,
            ...
            (function (a, f) {
                ...
                var p = c.n(d), h = c(11);
                d = c(15);
                var q = c(33), k = c(0), e = c(2), D = c(23), H = c(16), z = c(3), m = c(17),
                    u = "attributes namespace content parent next prev hidden".split(" ");
                d = function (b) {
                    function c(c, e, d) {
                    ...
                    d.writeCache = function (a, b, c) {
                        this.domCache && this.domCache.set(a, {node: b, data: c})
                    };
                    ...
                    d.dump = function () {
                        return {dom: new a(this.dom), index: new a(this.index)}
                    };
                    ...
                    d.getNodesIds = function (a) {
                        ...
                        return k.IterableUtils.toArray(a).map(function (a) {
                            return {id: b.getNodeId(a), nodes: b.getNodesIds(a.childNodes)}
                        })
                    };
                    d.reindexNodeTree = function (a, b) {
                        var c = this, e = void 0 === b ? {} : b, d = e.returnAll;
                        d = void 0 ===
                        d ? !1 : d;
                        var k = e.callback, g = void 0 === k ? null : k;
                        e = e.parentID;
                        var f = void 0 === e ? null : e;
                        if (a) {
                            var l = [];
                            if (a.parentNode || f) g = D.FunctionUtils.toFunction(g), h.c.each(a, function (a, b) {
                    ...
                    d.fastIndex = function (a) {
                        if (!this.disabled) {
                            var b = this.addToIndex.bind(this), c = this.initialDOM.add.bind(this.initialDOM);
                            h.c.each(a, function (a, e) {
                                var d = b(e, e.parentNode && e.parentNode._DOMIndexerID);
                                c(g()({}, d))
                            });
                            this.initialDOM.forEach(function (a) {
                                var b = a.nativeNode, c = b.previousSibling;
                                b = b.nextSibling;
                ...
                p()(d, "simplify", function (a) {
                    return k.IterableUtils.map(a, function (a) {
                        var b = {id: a.id, name: a.name.toLowerCase()};
                        k.IterableUtils.forof(u, function (c) {
                            null != a[c] && (b[c] = a[c])
                        });
                        return b
                    })
            ...
            (function (a) {
                ...
                d = function () {
                    ...
                    var c = b.prototype;
                    c.send = function (a, b) {
                        var c = this, d = void 0 === b ? {} : b, k = d.data, g = d.onResponse, f = d.onTimeout,
                            l = d.receiver, q = d.awaitResponse, n = d.timeoutTime, t = null, p = !1, h = !1, m, B = [],
                            u = Date.now();
                        "function" === typeof g && (p = !0, t = a + "." + this.timestamp, this.listenOnce(function (a) {
                            var b = a.data, e = b._ym_cancel_response, d = b.data;
                            if (b.type === t) e ? r["default"].warn("Seems like you forgot to call `answer` in a message handler. This message requires response.") :
                                (h = !0, g(d, {
                                    origin: a.origin,
                                    location: c.targetWindow.location.href,
                                    identifier: c.identifier
                                }), clearTimeout(m)); else return !1
                        }, this.targetWindow));
                        t && B.push("response:" + t);
                        (function Ga() {
                            c._sendMessage({data: k, type: a, target: c._getReceiver(l), flags: B});
                            if (q && p) {
                                var b = n;
                                void 0 === b && (b = 3E4);
                                b = Date.now() - u >= b;
                                !1 === h && (b ? "function" === typeof f && f() : m = G(Ga, 100))
                            }
                        })()
                    };
                    c.subscribe = function (a, b) {
                        var c = this._createSubscriptionsGroup(a);
                        if (!1 === this._isSubscribed(c, b)) c.push(b); else throw Error("This callback has already been subscribed to " +
                            a);
                    };
                    ...
                    c._sendMessage = function (a) {
                        ...
                        c = void 0 === c ? [] :
                            c;
                        b = {_ym_messenger: !0, _ym_identifier: this.identifier, type: b.type, data: b.data};
                        if (c && 0 < c.length) for (var d = 0, g = c.length; d < g; d++) {
                            var f = c[d].split(":");
                            b["_ym_" + f[0]] = f[1] || !0
                        }
                    ...
                    c._handleMessages = function () {
                        ...
                        if (null == this._cancelMainHandler) {
                            var b = this._attachEvent("message", function (b) {
                                var c = b.data ||
                                    {}, e = c._ym_response, d = c._ym_identifier, k = c.data, g = c.type;
                                if (!0 === c._ym_messenger && g && !/\.([0-9]+)$/.test(g)) {
                                    c = a._getSubcribers(g) || [];
                                    var f = a._findIframe(b.source, d);
                                    if (null === f) r["default"].warn("Cannot find iframe with id " + d); else {
                                        var q = {id: d, sender: f, data: k, type: g};
                                        b = 0;
                                        for (d = c.length; b < d; b++) {
                                            var n = c[b];
                                            e ? function () {
                                                var b = {type: e, target: f.contentWindow}, c = 2 === n.length,
                                                    d = null, k = function (e) {
                                                        clearTimeout(d);
                                                        e = c ? l()({}, b, {data: e}) : l()({}, b, {flags: ["cancel_response"]});
                                                        a._sendMessage(e)
                                                    };
                                                c ? (d = G(function () {
                    ...
                    c._findIframe = function (b, c) {
                        var e = this, d = [].slice.call(u.querySelectorAll("iframe"));
                        return a.find(d, function (a) {
                            if (a.contentWindow === b) return !0;
                            if (t.DOMUtils.isBlankOrSameOriginIframe(a, e.win)) try {
            ...
            function (a, b, c) {
                (function (a) {
                    var d = c(5), l = c.n(d), g = c(3);
                    d = function () {
                        function b(a, b, c) {
                            void 0 === a && (a = m);
                            void 0 === b && (b = u);
                            Object.defineProperty(this, "_indexer", {value: c});
                            this.window = a;
                            this.document = b;
                        ...
                        c.getPageSelection = function () {
                            ...
                            if (a) {
                                var b = this.indexer.getNodeId(a.startNode), c = this.indexer.getNodeId(a.endNode);
                                this.restoreIndexer();
                                return l()({}, a, {startNode: b, endNode: c})
                            }
                        };
                        c.restorePageSelection =
                            function (b) {
                                if (b) {
                                    var c = this.indexer.find(b.startNode), d = this.indexer.find(b.endNode);
                                    this.restoreIndexer();
                        ...
                        c.restoreSelection = function (a) {
                            var b = a.start, c = a.end, d = a.startNode;
                            a = a.endNode;
                            try {
                                var k =
                                    d.ownerDocument, e = k.defaultView.getSelection(), f = k.createRange();
                                f.setStart(d, b);
                                f.setEnd(a, c);
                                e.removeAllRanges();
                                e.addRange(f)
                            } catch (H) {
                                g["default"].log({start: {startNode: d, start: b}, end: {endNode: a, end: c}}, H)
                            }
                        };
                ...
                (function (a) {
                    var d = c(4), l = c(3), g = {
                        doNotTrack: function () {
                            ...
                            try {
                                return Object.defineProperty({}, "test", {value: 123}), !0
                            } catch (n) {
                                return !1
                            }
                        }
                ...
                (function (a) {
                    ...
                    var g = c(0), n = c(19), r = c(2), t = {
                        ...
                        document: "object" === typeof u && u || null
                    }, B = new d["default"], q = new d["default"], k = function (a) {
                    ...
                    d = Object.defineProperties({
                        regexp: t, patchCSS: function (a, b) {
                            var c = this, e = (void 0 === b ? {} : b).location, d = void 0 === e ? null : e, k = {
                            ...
                            return ["cssURLFinder", "URLImportFinder"].reduce(function (a, b) {
                                return c.patchURLS(a, t.get(b), d, k[b])
                            }, a)
                        }, patchURLS: function (a, b, c, e) {
                            var d = this, k = a, g = function (a) {
                                return "function" === typeof a ? a : function (a) {
                                    return a
                                }
                            }(e);
                            "string" === typeof a && a.match(b) && (k = a.replace(b, function () {
                                var a = d.patchURL(2 >= arguments.length ? A : arguments[2], {location: c});
                                return g(a)
                            }));
                            return k
                        },
                        patchURL: function (a, b) {
                            var c = this, e = void 0 === b ? {} : b, d = e.location, k = void 0 === d ? null : d;
                            e = e.split;
                            var g = void 0 === e ? !1 : e;
                            return "string" === typeof a ? function (a) {
                                return g ? a.split(",") : [a]
                            }(a).reduce(function (a, b) {
                                var e = b.trim().split(" "), d = e[0];
                                e = e.slice(1);
                                d = c.applyPatch(d, k);
                            ...
                            var e = t.test("relativePath", b), d = this.getRelativeLocation(c), k = d.host,
                                g = d.protocol;
                            d = d.path || d.pathname || "";
                            e = e ? this.resolvePath(b, d) : b;
                            if (0 <= H.indexOf(e)) return e;
                            if (q.has(e)) return B.get(e);
                            d = b;
                            t.resetAll();
                            if (t.test("dataurlTest", b) || t.test("selectorTest", b)) return b;
                            t.test("protocolMissing", b) && (d = t.test("protocolIncomplete", b) ? b.replace(t.get("protocolIncomplete"), g + "//") : g + "//" + (k + "/" + e).replace(/\/\/+/, "/"));
                            q.set(b, d);
                            /http[s]?/.test(d) ? (k = d, t.test("proxiedURL", k) ? d = k : (h.isWhitelisted ? (g = h.isWhitelisted(k)) && a.warn("Whitelisted: " + k) : g = !1, d = g ? k : (g = h.proxy) && t.test("resourceFinder", g) ? g.replace(t.get("resourceFinder"), encodeURIComponent(k)) : k), H.push(d),
                                B.set(b, d), k = d) : (H.push(b), B.set(b, d), k = b);
                            return h.noEncode ? decodeURIComponent(k) : k
                        }, getRelativeLocation: function (a) {
                            var b = t.test("relativePath", a);
                            return a ? b ? (b = n.StringUtils.parseURL(e(a)), a = this.resolvePath(a, this.location.protocol + "//" + this.location.host + (this.location.path || this.location.pathname || "")), b || r.ObjectUtils.assign({}, this.location, {path: a})) : r.ObjectUtils.assign({}, this.location, {path: a}) : this.location
                            ...
                            t.resetMultiple(["dataurlTest",
                                "selectorTest", "extnameFinder", "protocolMissing"]);
                            return t.test("dataurlTest", a) || t.test("selectorTest", a) ? !1 : t.test("extnameFinder", a) && t.test("protocolMissing", a)
                        }, clearCache: function () {
                            B.clear();
                            q.clear()
                        }, isProxiedURL: function (a) {
                            return a ? t.test("proxiedURL", a) : !1
                        }
                    }, {
                        location: {
                            get: function () {
                                ...
                                return (h = r.ObjectUtils.assign({}, h, {location: a})).location
                            }, configurable: !0, enumerable: !0
                        }, config: {
                            get: function () {
                                return h
                ...
                function d() {
                    try {
                        ...
                        var a = m.sessionStorage.getItem(l), b = !1;
                        try {
                ...
                var f = c(16), l = "__vw_tab_guid"
            }, function (a, b, c) {
                a = c(42);
                var d = c(31), f = c(43), l = c(44), g = c(45), n = c(46), r = c(47), t = c(48), h = c(49);
                c = c(50);
                b.a = {
                    input: a.a, keystrokes: function () {
                        return {
                            create: function (a) {
                                a.keyCapture.onCapture(function (b) {
                                    "OBJECT" ===
                                    u.activeElement.nodeName && /flash/.test(u.getAttribute("type")) || (b = a._getEventObject("keystroke", -1, b), a._publishActions(b))
                                })
                            }, destroy: function (a) {
                        ...
                        return {
                            create: function (a) {
                                var b = new a.MediaProxy, c = a._universalHandler(function (b) {
                                    b = a._getEventObject("mediaProperty", b.media, {property: b.name, value: b.value});
                                    a._publishActions(b)
                                }), e = a._universalHandler(function (b) {
                                    b = a._getEventObject("mediaMethod", b.media, {method: b.name, args: b.args});
                                    a._publishActions(b)
                                });
                        ...
                        var a = new d.a, b = 0, c = 0, e = function (e) {
                            var d = this, k = e.stamp, g = e.changes;
                            a.push(function () {
                                k !== b && (c = 0);
                                b = k;
                    ...
                    }, mouse: f.a, focus: l.a, resize: function () {
                        ...
                        return {
                            getValue: function () {
                                var a = this.viewport.getSize(1), b = a.width;
                                a = a.height;
                                ...
                                a = c.attachEvent(c.window, "resize", c._universalHandler(b, {extra: [this]}), {passive: !0})
                            }, destroy: function (b) {
                                b.removeEvent(a)
                            }
                        }
                    }, deviceRotation: g.a,
                    scroll: n.a, selection: r.a, touch: t.a, zoom: h.a, window: c.a, srcset: function () {
                        return {
                            create: function (a) {
                ...
                }, g = a.a.DOMIndexer.HIDABLE_NODES, n = new d.KeyValue, r = function (a, b) {
                    var c = a.ownerDocument.createElement(b), d = l.getNodeBounds(a);
                ...
                (function (a, f, l) {
                    ...
                    var k = c.n(d);
                    d = c(1);
                    var e = c.n(d), D = c(16), H = c(23), z = c(0), ca = c(13), x = c(30), w = c(63), y = c(51),
                        v = c(53), C = c(17), E = c(54), F = c(55), J = c(56), L = c(57);
                    d = c(15);
                    var I = c(26), T = c(58), U = c(59), ba = c(60), ra = c(21), O = c(61), Y = c(11), fa = c(62),
                        W = c(28), Z = c(10), P = c(37), pa = c(7), ha = c(2), K = c(3), Rb = c(64), S = {}, ta = {
                            counterId: null,
                            maxSize: 52428800,
                            maxDuration: 864E5,
                            compression: !1,
                        ...
                        }, X = {disableIndex: !1}, R = !0 === ba.a,
                        Q = pa.IS_INCOGNITO || pa.DO_NOT_TRACK || "disable" === W.BrowserUtils.meta("webvisor"),
                        Fa = m !== m.top;
                    m.__YM_WV_RECORDABLE__ === A && Object.defineProperty(m, "__YM_WV_RECORDABLE__", {value: !0});
                    var ja = function (b) {
                        function c(c, d) {
                            void 0 === c && (c = {});
                            void 0 === d && (d = {});
                            ...
                            e()(q()(k), "ableToStart", !1);
                            e()(q()(k), "_identifier", D.Tools.guid());
                            e()(q()(k), "offsets", {left: 0, top: 0});
                            e()(q()(k),
                                "fatalError", !1);
                            e()(q()(k), "captors", new a);
                            ...
                            e()(q()(k), "_slaveMessengerRegistrationHandler", function (a, b) {
                                return function (c, e) {
                                    var d = c.offsets, g = c.counterId, f = e.origin;
                                    try {
                                        var l = p()({}, k.options), D = f.split("//").pop(),
                                            n = g === l.counterId, q = D === m.location.host,
                                            r = -1 !== (l.trustedDomains || []).indexOf(D);
                                        q || r && n ? (k.offsets = d, k.sender.useRight(function (a) {
                                            var b = a.data, c = {};
                                            z.IterableUtils.fastIterate(["page", "events", "mutations"], function (a, e) {
                                                b[e] && (c[e] = b[e])
                                            });
                                            k.messenger.send("iframe_data", {data: c})
                            ...
                            e()(q()(k), "_sendEOF", H.FunctionUtils.once(function () {
                                if (!k._EOF_SENT) {
                                    ...
                                    k._saveChanges({events: [a]});
                                    k._EOF_SENT = !0
                                }
                            }));
                            k._context = function (a) {
                                var b = {};
                                return a ? (b.window = a.window || m, b.document = a.document || u, b) : {
                                    window: m,
                                    document: u
                                }
                            }(d);
                            ...
                            Object.defineProperty(k.window, "__WV_ENABLED__", {value: !0});
                        ...
                        d.configure = function () {
                            ...
                            Y.c.addAttributesFilter(function (b, c, e) {
                                if (C.a.isValidNode(b) && "value" === c) return b = C.a.validate(b, a), c = b.forceRecord, b.isAllowed || c ? e : C.a.encode(e)
                            })
                        };
                        ...
                        d.__initIndexer = function () {
                            var a = this;
                            this.indexer = new L.a(this.document, {disabled: this.initOptions.disableIndex}, this);
                        ...
                        d.connectSlaveRecorder = function (a) {
                            ...
                            if ("IFRAME" === a.nodeName && a.name !== ca.a.NATIVE_IFRAME_NAME &&
                                ...
                                var e = function eb(a) {
                                    var c = a.contentWindow, e = a.contentDocument;
                                    ...
                                    if (c && e) {
                                        ...
                                        a.contentWindow.__YM_RECORDING__ =
                                            !0;
                                        c = b._createInstance(b._configOptions, {window: c, document: e});
                        ...
                        d.start = function (a) {
                            ...
                            this.errorLogger(function () {
                                if (b.ableToStart) if (!1 === b.fatalError) if (!b.inited) b.savePageSnapshot(), b.fatal("init-failed", Error("Unknown error")); else {
                                    if (R && !Q) {
                                        clearTimeout(b.cancelIfNotStarted);
                                        var c = (a || {}).forms;
                                        b.options.recording = ha.ObjectUtils.combine({}, ta.recording, {keysMode: void 0 === c || c ? "regular" : "explicit"});
                                ...
                                } else b.stop(!0, !0); else (function V() {
                        ...
                        d.stop = function (a, b) {
                            ...
                            R && !Q && (!1 !== this.started && this.inited || a) && !0 !== this.stopped && (clearTimeout(this.cancelIfNotStarted), clearTimeout(this.sendErrors), this.captors.forEach(function (a) {
                                ...
                                a.destroy(c)
                            }), this.indexer && this.indexer.clear(), this.captors && this.captors.clear(), ra.a.invokeAll(this), this.summary && this.summary.destroy(), this.keyCapture && this.keyCapture.destroy(), b ? (this._sendEOF(), !0 === this.fatalError && this._sendPreCachedData({force: !0}), this.emit("stop")) : a && this.emit("close"), this.started = !1, this.stopped = !0)
                        };
                        d.fatal = function (a, b) {
                            void 0 === b && (b = null);
                            K["default"].error(b);
                            this.fatal = H.FunctionUtils.noop();
                            b = b || {message: "Unknown exception", stack: "No stack provided"};
                            this.fatalError ||
                        ...
                        d.throwError = function (a, b) {
                            void 0 === b && (b = "recorder");
                            this.emit("error", {error: a, namespace: "recorder:" + b})
                        };
                        ...
                        d._getEventObject = function (a, b, c, e) {
                            ...
                            return {stamp: this._stampForType(a, e), type: a, target: b, meta: c || null}
                        };
                        d._getMutationObject = function (a, b, c) {
                            void 0 === c && (c = 0);
                            return {stamp: b, meta: {changes: a, index: c}}
                        };
                        ...
                        d._getInitialScroll = function () {
                            var a = [], b = this.document.body, c = this._getScroll(b);
                            null != c && a.push(c);
                        ...
                        d._getScroll = function (a) {
                            ...
                            if (0 < b || 0 < c) return {target: this.findNode(a), scroll: [b, c]}
                        };
                        ...
                        d._initMasterMessenger = function () {
                            ...
                            this.messenger.subscribe("iframe_data", function (b) {
                                ...
                                if (null != e) {
                                    ...
                                    }), a._request("/dump", {page: e}));
                                    if (c.events) {
                                        b = Z.DOMUtils.offsets(b, {excludeBorder: !0});
                                        var k = b.left, g = b.top;
                                        b = c.events.map(function (b) {
                                            /mouse/.test(b.type) && (b.meta.x = Math.round(b.meta.x + k), b.meta.y = Math.round(b.meta.y + g));
                                            return p()({},
                                                b, d, {stamp: a._stampForType(b.type)})
                                        });
                                        a._publishActions(b)
                                    }
                                    c.mutations && (c = c.mutations.map(function (b) {
                                        return p()({}, b, d, {stamp: a._stampForType("mutation")})
                        ...
                        d._publishActions = function () {
                            var a;
                            this._saveChanges({events: (a = []).concat.apply(a, arguments)})
                        };
                        d._publishMutations = function () {
                            var a;
                            this._saveChanges({mutations: (a = []).concat.apply(a, arguments)})
                        };
                        d._request = function (a, b, c) {
                            void 0 === b && (b = {});
                            void 0 === c && (c = !1);
                            this._EOF_SENT && !0 !== c || (!0 === this.started || !0 === c ? (b = ha.ObjectUtils.combine({_v: ca.a["package"].version},
                                p()({}, b)), this.sender.send({url: a, data: p()({}, b)})) : this.precache.push([a, b]))
                        };
                        ...
                        d._createSnapshot = function () {
                            var a = this, b = f.resolve().then(function () {
                                return {content: a.summary.html}
                            })["catch"](function (a) {
                                return {error: a}
                            }).then(function (a) {
                                return {
                        ...
                        d.savePageSnapshot = function (a) {
                            if (this.indexer && !this.indexer.disabled && !this.snapshotSent) return this.snapshotSent = !0, a = p()({
                                ...
                                tabId: this.tabId,
                                recordStamp: (new Date).getTime()
                            }, this.page), this._saveChanges({page: a})
                        };
                        d._sendInitialEvents = function () {
                            var a = this, b = [], c = function () {
                                var b =
                                    a.captors.get("resize");
                                return b && b.getValue.call(a)
                            }(), e = this.viewport.scrollingElement, d = this._getInitialScroll().map(function (b) {
                                var c = b.scroll, d = c[0];
                                c = c[1];
                                b = a.indexer.find(b.target);
                                b = b === a.document || b === a.window ? e : b;
                                return a._getEventObject("scroll", b, {x: c, y: d, page: b === e})
                            });
                            c && b.push(c);
                            b.push.apply(b, d);
                            this._saveChanges({events: b})
                        };
                        d._sendPreCachedData = function (a) {
                            a = (void 0 === a ? {} : a).force;
                            a = void 0 === a ? !1 : a;
                            if (this.precache.length) for (var b; null != (b = this.precache.shift());) this._request(b[0],
                                b[1], a)
                        };
                        ...
                        d._sendMessage = function (a, b) {
                            (Fa ? this.window.top : this.window).postMessage({type: a, data: b}, "*")
                        };
                        d._universalHandler = function (a, b) {
                            var c = this, e = (void 0 === b ? {} : b).extra, d = void 0 === e ? [] : e;
                            return function () {
                        ...
                        B()(c, [{
                            ...
                            key: "bodyNode", get: function () {
                                return this.__bodyNode || (this.__bodyNode = this.document.body)
                            }
                        }, {
                            key: "fpsDelay", get: function () {
                                return 1E3 / this.fps
                            }
                        }, {
                            key: "doctype", get: function () {
                                if (!this.document.doctype) return "";
                                var a = this.document.doctype || {}, b = a.publicId, c = a.systemId;
                                return "\x3c!DOCTYPE " + [a.name ||
                                "html", b ? ' PUBLIC "' + b + '"' : "", !b && c ? " SYSTEM" : "", c ? ' "' + c + '"' : ""].join("") + "\x3e"
                            }
                        }, {
                            ...
                            key: "page", get: function () {
                                var a = this.viewport ? this.viewport.getSize() : {width: 0, height: 0},
                                    b = Z.DOMUtils.base(), c = !!this.document.querySelector("base[href]");
                                return {
                                    meta: {
                                        base: b,
                                        hasBase: c,
                                        ...
                                        screen: {width: ia.width, height: ia.height},
                                        location: {host: M.host, protocol: M.protocol, path: M.pathname}
                                    }
                                }
                            }
                        }, {
                ...
                (function (b) {
                    var d = c(69), l = c(83), g = Object.create, n = Object.defineProperties, r = Object.defineProperty,
                        h = Object.prototype, p, m = g(null);
                    if ("function" === typeof b) {
                        var q = b;
                        try {
                            String(q());
                    ...
                    a.exports = p = function ca(a) {
                        ...
                        var b = g(D.prototype);
                        a = a === A ? "" : String(a);
                        return n(b, {__description__: d("", a), __name__: d("", e(a))})
                    };
                    n(p, {
                        "for": d(function (a) {
                    ...
                    n(D.prototype, {
                        constructor: d(p), toString: d("", function () {
                    ...
                    r(D.prototype, p.toStringTag, d("c", p.prototype[p.toStringTag]));
                    r(D.prototype, p.toPrimitive, d("c", p.prototype[p.toPrimitive]))
                }).call(this, c(25)["default"])
            }, function (a, b, c) {
                var d = c(70), f = c(78), l = c(79), g = c(80);
                (a.exports = function (a, b) {
                    var c;
                    ...
                    n = {value: b, configurable: n, enumerable: q, writable: c};
                    return l ? d(f(l), n) : n
                }).gs = function (a, b, c, h) {
                    ...
                    b = {get: b, set: c, configurable: n, enumerable: a};
                    return h ? d(f(h), b) : b
                }
            }, function (a, b, c) {
                ...
                a.exports = function () {
                    ...
                    var b = {foo: "raz"};
                    a(b, {bar: "dwa"}, {trzy: "trzy"});
                    return "razdwatrzy" === b.foo + b.bar + b.trzy
                }
            }, function (a, b, c) {
                var d = c(73), f = c(77), l = Math.max;
                a.exports = function (a, b) {
                ...
                var d = c(35), f = Array.prototype.forEach, l = Object.create;
                a.exports = function (a) {
                    var b = l(null);
                ...
                (function (b) {
                    (function (b, c) {
                        ...
                        function n() {
                            var a = 0, b = new W(p), c = u.createTextNode("");
                        ...
                        function q(a, b) {
                            var c = this, d = new this.constructor(e);
                            d[ha] === A && L(d);
                            var k = c._state;
                            if (k) {
                                var g = arguments[k - 1];
                        ...
                        function ca(a, b) {
                            b._state === U ? v(a, b._result) : b._state === S ? C(a, b._result) : E(b, A, function (b) {
                                return w(a,
                                    b)
                            }, function (b) {
                                return C(a, b)
                        ...
                        function x(b, c, e) {
                            c.constructor === b.constructor && e === q && c.constructor.resolve === k ? ca(b, c) : e === R ? (C(b, R.error), R.error = null) : e === A ? v(b, c) : a(e) ? z(b, c, e) : v(b, c)
                        }

                        function w(a, b) {
                            if (a === b) C(a, new TypeError("You cannot resolve a promise with itself")); else {
                                var c = typeof b;
                                null === b || "object" !== c && "function" !== c ? v(a, b) : x(a, b, D(b))
                            }
                        }
                        ...
                        function E(a, b, c, e) {
                            var d = a._subscribers, k = d.length;
                            a._onerror = null;
                            d[k] = b;
                            d[k + U] = c;
                            d[k + S] = e;
                        ...
                        function J(b, c, e, d) {
                            var k = a(e), g = void 0, f = void 0, l = void 0, D = void 0;
                            if (k) {
                                try {
                                    g = e(d)
                                } catch (sa) {
                                ...
                                g === R ? (D = !0, f = g.error, g.error = null) : l = !0;
                                if (c === g) {
                                    C(c, new TypeError("A promises callback cannot return that same promise."));
                                    return
                                }
                            } else g = d, l = !0;
                            c._state === K && (k && l ? w(c, g) : D ? C(c, f) : b === U ? v(c, g) : b === S && C(c, g))
                        }
                        ...
                        var I = void 0, T = I = Array.isArray ? Array.isArray : function (a) {
                                return "[object Array]" === Object.prototype.toString.call(a)
                            }, ba = 0, ra = void 0, O = void 0, Y = function (a, b) {
                                P[ba] = a;
                                P[ba + 1] = b;
                                ba += 2;
                                2 === ba && (O ? O(p) : pa())
                        ...
                        var Z = "undefined" !== typeof Uint8ClampedArray && "undefined" !== typeof importScripts && "undefined" !== typeof MessageChannel,
                            P = Array(1E3), pa = void 0;
                        pa = fa ? c() : W ? n() : Z ? h() : I === A ? B() : t();
                        var ha = Math.random().toString(36).substring(2), K = void 0, U = 1, S = 2, R = {error: null},
                            X = 0, ea = function () {
                                function a(a, b) {
                                    ...
                                    T(b) ? (this._remaining = this.length =
                                        b.length, this._result = Array(this.length), 0 === this.length ? v(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(b), 0 === this._remaining && v(this.promise, this._result))) : C(this.promise, Error("Array Methods must be provided an Array"))
                                }
                                ...
                                a.prototype._eachEntry = function (a, b) {
                                    ...
                                    d === k ? (d = D(a), d === q && a._state !== K ? this._settledAt(a._state, b, a._result) :
                                ...
                                a.prototype._settledAt = function (a, b, c) {
                                    var e = this.promise;
                                    e._state === K && (this._remaining--, a === S ? C(e, c) : this._result[b] = c);
                            ...
                            Q = function () {
                                function b(a) {
                                    ...
                                    if (e !== a) {
                                        ...
                                        if (this instanceof b) M(this, a); else throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");
                                    }
                                }
                ...
                a.exports = c(88);
                if (d) b.regeneratorRuntime = f; else try {
                ...
                (function (b, c) {
                    !function (d) {
                            ...
                            return function (k, g) {
                                ...
                                for (c.arg = g; ;) {
                                    ...
                                    if ("normal" === l.type) {
                                        d = c.done ? L : J;
                                        if (l.arg === I) continue;
                                        return {value: l.arg, done: c.done}
                                    }
                        ...
                        function e(a, b) {
                            ...
                            if (c.done) b[a.resultName] = c.value, b.next = a.nextLoc, "return" !== b.method && (b.method = "next", b.arg = y); else return c;
                            b.delegate = null;
                            return I
                        }
                        ...
                        function ca(a) {
                            if (a) {
                                ...
                                if (!isNaN(a.length)) {
                                    var c = -1;
                                    b = function P() {
                                        for (; ++c < a.length;) if (w.call(a, c)) return P.value = a[c], P.done = !1, P;
                                        P.value =
                                            y;
                                        P.done = !0;
                                        return P
                        ...
                        var x = Object.prototype, w = x.hasOwnProperty, y, v = "function" === typeof b ? b : {},
                            A = v.iterator || "@@iterator", C = v.asyncIterator || "@@asyncIterator",
                            E = v.toStringTag || "@@toStringTag";
                        v = "object" === typeof a;
                        var F = d.regeneratorRuntime;
                        if (F) v && (a.exports = F); else {
                            F = d.regeneratorRuntime = v ? a.exports : {};
                            F.wrap = g;
                            var G = "suspendedStart", J = "suspendedYield", M = "executing", L = "completed", I = {};
                            d = {};
                            d[A] = function () {
                                return this
                            };
                            ...
                            z.prototype = {
                                constructor: z, reset: function (a) {
                                    ...
                                    if (!a) for (var b in this) "t" === b.charAt(0) && w.call(this, b) && !isNaN(+b.slice(1)) && (this[b] = y)
                                }, stop: function () {
                                    this.done = !0;
                                    ...
                                    for (var c = this, e = this.tryEntries.length - 1; 0 <= e; --e) {
                                        var d = this.tryEntries[e], k = d.completion;
                                        if ("root" === d.tryLoc) return b("end");
                                        if (d.tryLoc <= this.prev) {
                                            var g = w.call(d, "catchLoc"), f = w.call(d, "finallyLoc");
                                            if (g && f) {
                                    ...
                                    this.delegate =
                                        {iterator: ca(a), resultName: b, nextLoc: c};
                ...
                var d = c(3), f = {
                    toChunks: function (a, b) {
                        var c = a.slice(0), g = c.length, f = g === b ? Math.round : Math.floor, l = 0;
                        return c.reduce(function (a, n, k) {
                            var e = f(b / (g / k));
    ...
    var y = I.inherit({
        _initComponent: function () {
            ...
            f = y._getOpts(f);
            b = b.split(",");
            var l = b.length, g = this._listeners, n;
            for (n = 0; n < l; n++) {
                var h = b[n];
                var t = F(function (a) {
                    c.call(d || this, a || m.event)
                }, "on" + (h || "") + (f.name || ""));
                g[g.length] = [a, h, c, d, f, t];
                a.addEventListener ? a.addEventListener(h, t, y._prepOpts(f)) : a.attachEvent && a.attachEvent("on" + h, t)
            }
        }, un: function (a, b, c, d, f) {
            f = y._getOpts(f);
            var l = this._listeners, g = l.length, n;
            for (n = 0; n < g; n++) {
                var r = l[n];
    ...
    y._getOpts = function (a) {
        return h.mixin({capture: !0, passive: !0}, a || {})
    };
    ...
    var Va = I.inherit({
            ...
            }, maxBufferSize: 255, flushTimeout: 1E4, startBufferTime: 0, active: !0, meta: null, onFlush: function () {
    ...
    h.async = function (a, b, c) {
        if (m.postMessage) {
            ...
            var f = function (c) {
                ...
                g === d && (c.stopPropagation && c.stopPropagation(), a.call(b), y.un(m, "message", f, null, {passive: !1}))
            };
            y.on(m, "message", f, null, {passive: !1, name: ".async." + (c || "")});
            m.postMessage(d, "*")
    ...
    var Xb = I.inherit({
        transports: [], globalConfig: C, postParams: [], isDisabled: function () {
            return this.globalConfig.get("oo")
        }, send: function (a, b, c, d) {
            var f = [a], l = this, g = c || function () {
            };
            l.isDisabled() ? g.call(d) : function t(a) {
                if (a < this.transports.length) try {
                    ...
                    ua(B, "send by " + (c && c.id)), t.call(this, a + 1)
                }
            }.call(this, 0)
        }
    }), Ca = {};
    ...
    Ca.stringify = function (a, b) {
        var c = [], d = b || {}, f = {}, l = h.keys(a).length, g, n;
        if (d.lastOrdering !== A) for (n = 1; n <= b.lastOrdering.length; n++) f[b.lastOrdering[n - 1]] = l + n;
        if (d.firstOrdering !== A) for (n = 0; n < b.firstOrdering.length; n++) f[b.firstOrdering[n]] = n;
        for (g in a) if (a.hasOwnProperty(g)) if (d = a[g], h.isArray(d)) for (n = 0; n < d.length; n++) c.push({
            key: g,
            value: encodeURIComponent(g) + "\x3d" + encodeURIComponent(String(d[n]))
        }); else c.push({
            key: g, value: encodeURIComponent(g) +
    ...
    var Xa = wa.inherit({
            ...
            _initComponent: function () {
                ...
                this._doc = this._htmlfile || (this.htmlfileOnly ? null : u)
            },
        ...
        }), Zb = Xa.inherit({id: "htmlfile", index: 3, htmlfileOnly: !0}),
        Da = wa.inherit({
            id: "img", index: 4, request: function (a, b, c, d) {
                a = this._buildUrl(a, b);
                var f = !1;
                b = u.createElement("img");
                c = c || function () {
                };
                b.onload = F(function () {
                    f || (c.call(d, !0), f = !0)
    ...
    var na = {
        ...
        tailSafe: "*-_",
        encode: function (a, b) {
            var c = (na.abc + (b ? na.tailSafe : na.tail)).split(""), d = a.length, f = [], l = d - d % 3, g;
            for (g = 0; g < l; g += 3) {
        ...
        decode: function (a, b) {
            for (var c = na.abc + (b ? na.tailSafe : na.tail), d = 0, f = "", l, g, n, h, t; a.length % 4;) a += "\x3d";
            do {
                l = c.indexOf(a.charAt(d++));
                g = c.indexOf(a.charAt(d++));
                h = c.indexOf(a.charAt(d++));
                t = c.indexOf(a.charAt(d++));
                if (0 > l || 0 > g || 0 > h || 0 > t) return null;
                n = l << 18 | g << 12 | h << 6 | t;
                l = n >> 16 & 255;
                g = n >> 8 & 255;
                n &= 255;
                f = 64 == h ? f + String.fromCharCode(l) : 64 == t ? f + String.fromCharCode(l, g) : f + String.fromCharCode(l,
                    g, n)
            } while (d < a.length);
            return f
        }
    ...
    T.get = function (a) {
        return (new T({onlyCurrentDomain: !0})).read(a)
    };
    T.set = function (a, b, c) {
        return (new T({onlyCurrentDomain: !0})).create(a, b, c)
    };
    T.isEnabled = function () {
        return (new T({onlyCurrentDomain: !0})).isEnabled()
    };
    h.isNativeFunction =
        function (a, b) {
    ...
    var Ea = {
        ...
        getInfoFlags: function () {
            return {pi: this.getYm, pid: this.getYmD, zz: this.getZZ, pp: this.getPP, pu: this.getPU, fip: this.getFip}
        },
        checkVersion: function () {
            ...
            a = x.getMacOSVersion();
            return !((x.isIOS() || 10 < a[0] || 10 === a[0] && 13 <= a[1]) && x.isSafari()) || x.isSafariWebView()
        },
        noop: function () {
        },
        genPu: function (a) {
        ...
        genYm: function (a) {
            ...
            if (!this.checkVersion() && m.fetch && this._storage.get("retryReqs") && "yandex.ru" == c.hostname && "/" == c.pathname && !(a.lt && a.lt + 1440 > d)) {
                ...
                fetch("//" + f, {credentials: "include"}).then(function (a) {
                    return a.json()
                }).then(function (c) {
                    c && (a.resp = c._ym_uid, a.dmn = na.encode(Qa.encode(f)), b._storage.set(b.ymKey, a))
                })["catch"](function () {
        ...
        initPU: function (a, b) {
            ...
            b.get("pu") !== A || this.checkVersion() && !d || (b.setSafe("pu", null), a.addHandler("gpu-get", function () {
                ...
                c.genPu(b)
            }, 200, "pu"), a.sendToIframe(m.opener, {type: "gpu-get"}, this.handleGpu(d), this)) : this.genPu(b))
        },
        ...
        initZZ: function () {
            var a = "ru";
            var b = x.isFF(68);
            var c = x.edgVersion(), d = this;
            if (!this.getZZ() && (!this.checkVersion() || b)) {
                if (b || c && 79 <= c) a = "md";
                b = h.getNativeFunction("createElement", u)("iframe");
                b.style.display = "none";
                b.style.width = "1px";
                b.style.height = "1px";
                b.style.visibility = "hidden";
                b.src = "https://mc.yandex." + a + na.decode("L21ldHJpa2EvenpsYy5odG1s");
                m.document.documentElement.appendChild(b);
                y.on(m, "message", this.onMessage, this, {passive: !1});
                this.frame = b;
                this.timeout = h.setTimeout(function () {
                    y.un(m, "message", d.onMessage, d, {passive: !1});
                    w.removeNode(d.frame);
                    d.zz = "na"
                }, 3E3, "cd.initZZ")
            }
        },
        onMessage: function (a) {
            a.data && a.data.substr && "__ym__zz" === a.data.substr(0, 8) && (this.zz = a.data.substr(8), w.removeNode(this.frame), this._storage.set(this.key, this.zz), y.un(m, "message", this.onMessage, this, {passive: !1}), h.clearTimeout(this.timeout))
        },
        fipKey: "fip",
        ...
        initFip: function () {
            var a = 0;
            a = x.isFF(68);
            !Object.keys || this.checkVersion() && !a || this._storage.get(this.fipKey) || (a = new jb(h.reduce(function (a,
                                                                                                                          c) {
                a[c] = 1;
                return a
        ...
        send: function (a, b, c, d) {
            var f = this.globalConfig.get(xa.globalKey), l = this;
        ...
        _sendSavedRequest: function (a, b, c, d, f) {
            var l = this.globalConfig.get("firstReqStatus"), g = b.forceNoRedirect;
            if ("process" == l) this.globalConfig.set("firstReqCallbacks", h.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [], [[this, arguments]])); else {
                ...
                return U.superclass.send.call(this, l, b, function () {
                    var b;
                    this.globalConfig.set("firstReqStatus",
                        "complete");
    ...
    U.initCookie = function (a) {
        var b =
                new T({onlyCurrentDomain: "uid" !== a}), c = b.read(a), d = U._storage.get(a), f = !1, l = b.read("d"),
            g = v.getSeconds();
        d && !c && (c = d, f = !0, b.create(a, c, 525600), b.create("d", g, 525600));
        if (!c) c = g + "" + h.random(), b.create(a, c, 525600), b.create("d", g, 525600); else if (!l || 15768E3 < g - parseInt(l)) b.create(a, c, 525600), b.create("d", g, 525600);
        U._storage.set(a, c);
        U._userID = c;
        return f
    };
    U.retransmit = function (a) {
        var b = U._storage, c = b.get("retryReqs") || {}, d;
        b.remove("retryReqs");
        h.forEachKey(c, function (b, c) {
            var g = v.getMs();
            a.get("firstReqStatus") ||
            a.set("firstReqStatus", "complete");
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 1728E5 > g && 500 < g - c.time && 2 >= c.browserInfo.rqnl && (d = new U({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    var $b = /(\?|&)turbo_uid=([\w\d]+)($|&)/, ac = h.memorize(function () {
        var a = new T, b = L();
        return function (c) {
            return c(a, b)
        }
    }), bc = function (a, b) {
        var c = b.search.match($b), d = null, f = a.read("turbo_uid");
    ...
    h.is4Bytes = function (a) {
        return !h.arrayEvery((encodeURIComponent(a).match(/(%[A-F,\d]{2})+/g) ||
    ...
    h.parseUrl = function (a) {
        if (!this._urlParser) try {
            this._urlParser = u.createElement("a")
        } catch (b) {
        }
    ...
    w.getDocumentCharset = function () {
        return ("" + (u.characterSet || u.charset || "")).toLowerCase()
    };
    w.getBody = function () {
        for (var a = u.getElementsByTagName("body"); 0 <
        a.length;) return a[0]
    };
    w.getRootElement = function () {
        var a = u.documentElement, b = w.getBody();
        return "CSS1Compat" == u.compatMode ? a : b || a
    };
    ...
    w.getDocumentTitle = function () {
        var a = u.title;
        "string" != typeof a && (a = (a = u.getElementsByTagName("title")) && a.length ? a[0].innerHTML : "");
        return a
    };
    x.getSilverlightVersion = h.memorize(function () {
        ...
        } else if (b = m.navigator, b = b.plugins && b.plugins["Silverlight Plug-In"]) f = b.description;
        return f || ""
    });
    x.getFlashVersion = h.memorize(function () {
        ...
        if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
            ...
            var c = b.version;
            if ((b = b.description) || c) if (a = a.mimeTypes, "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin) c ? x._flashVersion = c : b && (x._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/, "."))
    ...
    x.getFingerPrint = h.memorize(function () {
        ...
        if (navigator.plugins && navigator.plugins.length) for (b = 0; b < navigator.plugins.length; b++) {
            ...
            h.mergeArrays(a, [c.name, c.version, c.description,
                c.filename])
        }
        if (navigator.mimeTypes && navigator.mimeTypes.length) for (b = 0; b < navigator.mimeTypes.length; b++) c = navigator.mimeTypes[b], h.mergeArrays(a, [c.type, c.description, c.suffixes]);
    ...
    x.isHeadLess = h.memorize(function () {
        ...
        for (a = 0; a < b.length; a++) if (m[b[a]]) return !0;
    ...
    y.ready = function (a) {
        var b = u.readyState;
        if ("interactive" === b || "complete" === b) h.setTimeout(a, 0, "evt::ready"); else {
            var c = function () {
                y.un(u, "DOMContentLoaded", c);
                y.un(m, "load", c);
                a()
            };
            y.on(u,
    ...
    var yb = {
        url: "https://mc.yandex.ru/metrika/", _value: null, init: function (a) {
            var b = this._getLs().read("isad");
            this.globalConfig = a || C;
    ...
    var Ra = U.inherit({
        ...
        sendHit: function (a) {
            this._hitExt({
                ...
                referrer: a.referrer,
                vParams: a.vParams,
                modes: h.mixin(a.modes || {}, {ar: !0, saveRef: !0, pv: !0}),
                callback: a.callback,
        ...
        sendExperiments: function (a) {
            this._hitExt({
                url: L().href, title: "", referrer: "",
                modes: {ex: !0, ar: !0}, experiments: a.experiments, callback: a.callback, ctx: a.ctx
            }, "exp")
        },
        ...
        sendGoal: function (a,
                            b) {
            if (/[/&=?#]/.test(a)) h.warning("Incorrect goal"); else if (a) {
        ...
        sendClickLink: function (a, b) {
            this._hitExt({url: a.url, title: a.title, referrer: b || L().href, modes: a.modes})
        },
        sendExtLink: function (a, b) {
            this._hitExt({
                url: a.url, title: a.title || "", referrer: b ||
                    L().href, vParams: a.vParams, modes: {ar: !0, ln: !0, ut: kb}, callback: a.callback, ctx: a.ctx
            }, "cl")
        },
        ...
        sendDevice: function (a) {
            this._hitExt({
                browserInfo: {di: a.data, dip: a.port}, callback: a.callback,
                ctx: a.ctx
            }, "de")
        },
        _hitExt: function (a, b) {
            ...
            if (!h.isMetrikaPlayer()) {
                var n = a.modes || {};
                var r = a.browserInfo || {};
                var t = "undefined" !== typeof a.referrer ? a.referrer : Za.lastReferrer;
                var p = a.url || "";
                var m = {};
                a.nohit && c("nohit", 1);
                n.ar && !n.onlyData && (t = null === t || "" === t ? "" : this._prepareHitUrl(t), p = this._prepareHitUrl(a.url));
                c("forceNoRedirect", a.forceNoRedirect);
                c("page-ref", h.trim(t, lb));
                c("page-url", h.trim(p, lb));
                h.is4Bytes(a.title) && c("charset", "utf-8");
                -1 != L().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ?
        ...
        getFu: function (a, b) {
            var c = a !== L().href, d = u.referrer.replace(/\/$/, ""), f = (b || "").replace(/\/$/, "");
            d = d !== f;
            f = 0;
            d && c ? f = 3 : d ? f = 1 : c && (f = 2);
            return f
        },
        _getTechInfo: function (a, b, c, d, f, l, g, n, r, t) {
            function p(a, b, c) {
                var e = "" + b;
            ...
            h.random(100) || p("np", na.encode(Qa.encode(h.trim(x.getPlatform(), 100))));
            l && p("wh", "1");
            ...
            for (d = 0; d < f.length; d++) l = f[d], p(l,
                b[l]);
            f = new ea({counterId: c});
            f.isEnabled() && (c = f.getStorageId(), d = f.get("reqNum"), t || (d ? d++ : d = 1), f.set("reqNum", d), f.get("reqNum") == d ? (p("ls", c), p("rqn", d)) : (f.remove("reqNum"), f.clearStorageId(), 1 < d && (p("ls", c), p("rqn", 0))));
            p("rn", h.random());
            p("hid", g);
            t || 3 == this.counterId || b.pq || p("ds", Tb(r));
            r._firstPaint || t || (r._firstPaint = Vb(), p("fp", r._firstPaint));
            if (n) {
                g = C.get("winNameNum");
                if (!g) {
    ...
    var Ja = I.inherit({
        sampling: 1, counterId: 26302566, _initComponent: function () {
            ...
            this._sender = new Ra({protocol: "https:", counterId: this.counterId, retry: !1, counter: {}})
        }, log: function () {
        ...
        resource: "webvisor", retry: !0, postParams: ["wv-data"], sendPacket: function (a, b, c, d, f, l, g, n) {
            if (!a || !a.length) return !1;
            var r = na.encode(a, !0);
            if (0 == r.indexOf("AAAAAAAAADw") && m.Error) {
                var t = Error();
                "string" == typeof t.stack && (new Ja({sampling: .1})).log("bad visor packet 5",
                    1)
            }
            a = {
                rn: h.random(),
    ...
    w.getDocumentHTML = function () {
        ...
        if (c = u.doctype) a = c.publicId ? ' PUBLIC "' + c.publicId + '"' : "", l = c.systemId ? ' "' + c.systemId + '"' : "", a = "\x3c!DOCTYPE " +
            c.name + a + l + "\x3e\n";
        return a + b
    };
    w.getElementParent = function (a) {
        if (!a || a == u.documentElement) return null;
        if (a == w.getBody()) return u.documentElement;
        var b = null;
        try {
            b = a.parentNode
        } catch (c) {
    ...
    w.getDocumentScroll = function () {
        var a = w.getBody();
        return [m.pageXOffset || u.documentElement && u.documentElement.scrollLeft || a && a.scrollLeft || 0, m.pageYOffset || u.documentElement && u.documentElement.scrollTop || a && a.scrollTop || 0]
    };
    w.getElementXY = function (a) {
        var b;
        if (!a || !a.ownerDocument || "PARAM" == a.tagName || a == w.getBody() || a == u.documentElement) return [0, 0];
    ...
    w.getDocumentSize = function () {
        var a = w.getRootElement(), b = w.getViewportSize();
        return [Math.max(a.scrollWidth, b[0]), Math.max(a.scrollHeight, b[1])]
    };
    w.getElementSize = function (a) {
        var b;
        return a == w.getBody() || a == u.documentElement ? w.getDocumentSize() : (b = a.getBoundingClientRect && a.getBoundingClientRect()) ? [b.width, b.height] : [a.offsetWidth,
            a.offsetHeight]
    };
    ...
    w.getFormNumber = function (a) {
        var b = u.getElementsByTagName("form"), c;
        var d = 0;
        ...
        if (wb) {
            var jb = function (a) {
                ...
                return b.ka = a, b.fa = c, b.i = function (a, c, l) {
                    b.O(a, c) || Object.defineProperty(a, c, {enumerable: !0, get: l})
                }, b.s = function (a) {
                    "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(a, Symbol.toStringTag, {value: "Module"});
                    Object.defineProperty(a, "__esModule", {value: !0})
                }, b.ja = function (a, c) {
                    ...
                    if (b.s(d), Object.defineProperty(d, "default",
                        {
                            enumerable: !0,
                            value: a
                        }), 2 & c && "string" != typeof a) for (var g in a) b.i(d, g, function (b) {
                        return a[b]
                    }.bind(null, g));
                    return d
                }, b.ga = function (a) {
                ...
                var d = this && this.da || function () {
                    return (d = Object.assign || function (a) {
                        for (var b, c = 1, e = arguments.length; c < e; c++) for (var d in b = arguments[c]) Object.prototype.hasOwnProperty.call(b,
                            d) && (a[d] = b[d]);
                        return a
                    }).apply(this, arguments)
                };
                b.a = !0;
                var f = c(1), l = c(2), g = c(3), n = c(4), h = c(5), t = c(7), p = c(8), m = c(9), q = c(10),
                    k = c(11), e = c(12), D = c(13);
                a = function () {
                    function a(a) {
                        var b = this;
                        this.l = a;
                    ...
                    return a.prototype.toString = function (a) {
                        ...
                        return a ? [D.hash(b.join(""), 210)] : b.map(function (a) {
                            return D.hash(a, 210)
                        })
                    }, a
                }();
                ...
                var d = function (a) {
                    ...
                    return c(b, a), b.prototype.V = function () {
                        ...
                        b.push("webgl max vertex texture image units:" +
                        ...
                        return a.getShaderPrecisionFormat ? (b.push("webgl vertex shader high float precision:" + a.getShaderPrecisionFormat(a.VERTEX_SHADER, a.HIGH_FLOAT).precision), b.push("webgl vertex shader high float precision rangeMin:" + a.getShaderPrecisionFormat(a.VERTEX_SHADER,
                            ...
                            b.push("webgl fragment shader low int precision rangeMax:" + a.getShaderPrecisionFormat(a.FRAGMENT_SHADER, a.LOW_INT).rangeMax), b.join("~")) : b.join("~")
                    }, b
                }(a = function () {
                    function a(a) {
                        this.P = a;
                        this.g = !0;
                        this.canvas = u.createElement("canvas");
                        this.U() || (this.g = !1)
                    }
                ...
                a = function () {
                    ...
                    return a.prototype.b = function () {
                        ...
                        return [a("prefers-reduced-motion"), a("prefers-reduced-transparency"), a("prefers-color-scheme: dark"), a("prefers-color-scheme: light"), a("pointer: none"), a("pointer: coarse"),
                            a("pointer: fine"), a("any-pointer: none"), a("any-pointer: coarse"), a("any-pointer: fine"), a("scan: interlace"), a("scan: progressive"), a("color-gamut: srgb"), a("color-gamut: p3"), a("color-gamut: rec2020"), a("update: fast"), a("update: slow"), a("update: none"), a("grid: 0"), a("grid: 1"), a("hover: hover"), a("inverted-colors: inverted"), a("inverted-colors: none")].join("x")
                    }, a
                }();
                b.G = a
            }, function (a, b) {
                ...
                a = function () {
                    ...
                    return a.prototype.b = function () {
                        ...
                        return [a.appName, a.vendor,
                            a.i, a.s, a.maxTouchPoints, a.appVersion, a.productSub, a.appCodeName, a.vendorSub, a.getGamepads && a.getGamepads().length].join("x")
                    }, a
                }();
                b.H = a
            }, function (a, b) {
                ...
                a = function () {
                    ...
                    return a.prototype.w = function (a) {
                        ...
                        for (var a = u.createElement("video"), b = [], c = 1; c < this.types.length; c++) {
                ...
                function h(a) {
                    ...
                    1]), g(a = c(a, [3301882366, 444984403]), [0, a[0] >>> 1])
                }

                b.a = !0;
                b.hash = function (a, b) {
                    b = b || 0;
                    var n = (a = a || "").length % 16, r = a.length - n, q = [0, b];
                    b = [0, b];
                    for (var k, e, D = [2277735313, 289559509], H = [1291169091, 658871167], z = 0; z < r; z += 16) k = [255 & a.charCodeAt(z + 4) | (255 & a.charCodeAt(z + 5)) << 8 | (255 & a.charCodeAt(z + 6)) << 16 | (255 & a.charCodeAt(z + 7)) << 24, 255 & a.charCodeAt(z) | (255 & a.charCodeAt(z + 1)) << 8 | (255 & a.charCodeAt(z + 2)) << 16 | (255 & a.charCodeAt(z + 3)) << 24], e = [255 & a.charCodeAt(z + 12) | (255 & a.charCodeAt(z + 13)) << 8 | (255 & a.charCodeAt(z +
                        14)) << 16 | (255 & a.charCodeAt(z + 15)) << 24, 255 & a.charCodeAt(z + 8) | (255 & a.charCodeAt(z + 9)) << 8 | (255 & a.charCodeAt(z + 10)) << 16 | (255 & a.charCodeAt(z + 11)) << 24], k = f(k = c(k, D), 31), q = d(q = f(q = g(q, c(k, H)), 27), b), q = d(c(q, [0, 5]), [0, 1390208809]), e = f(e = c(e, H), 33), b = d(b = f(b = g(b, c(e, D)), 31), q), b = d(c(b, [0, 5]), [0, 944331445]);
                    switch (k = [0, 0], e = [0, 0], n) {
                        ...
                        case 9:
                            e = c(e = g(e, [0, a.charCodeAt(z + 8)]), H), b = g(b, c(f(e, 33), D));
                        case 8:
                        ...
                        case 1:
                            k = c(k = g(k, [0, a.charCodeAt(z)]), D), q = g(q, c(f(k, 31), H))
                    }
                    return q =
                        d(q = g(q, [0, a.length]), b = g(b, [0, a.length])), b = d(b, q), q = d(q = h(q), b = h(b)), b = d(b, q), ("00000000" + (q[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (q[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
                }
            }]);
            jb = jb["default"]
        }
    } catch (a) {
        Pa = {error: a, scope: "fip"}
    }
    ...
    var mb = {
        ...
        callByTimeout: function (a, b) {
            for (var c = v.getMs(), d = 0, f, l = (b || 0) + 1, g = 0, n = this; this.asyncBuffer.length;) if (f = this.asyncBuffer.shift(), g += 1, !f.isExecuted && (F(function () {
                f.fn.apply(f.ctx, f.args)
            }, "AsyncExecutor." + f.loggerName)(), d = v.getMs() - c, f.isExecuted = !0, !a && (g >= this.asyncChunk ||
                d >= this.maxDuration))) {
                h.setTimeout(function () {
                    n.callByTimeout(a, l)
                }, this.restTime);
        ...
        id: "XHRPlain", index: 8, _splitParams: function (a) {
            var b = {}, c = {};
            h.forEachKey(a, function (a, f) {
        ...
        version: 2, retry: !1, postParams: ["wv-data"], transports: [fc], _initComponent: function () {
            ...
            f = {et: g, w: t[0] + "x" + t[1], v: this._getVersion(), z: f, i: l};
        ...
        append: function (a) {
            !this._data.length && a && a.length && (this.startBufferTime =
                v.getSeconds());
        ...
        addData: function (a, b, c, d, f) {
            var l = 0, g = 1, n = {type: a}, r = .9 * this.maxBufferSize;
            if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit) if (this._v = c, this.wrappers.length && h.arrayEvery(this.wrappers, function (c) {
                c.trigger &&
                c.trigger(a, b);
                return 1
            }), f) this._getSize("{}"), this.append([], d); else {
                this.updateStamp(b, n);
                c = R.stringify(b);
                f = this._getSize(c);
                if (f > this.maxBufferSize) for (this._data.length && this._flush(), d = Math.ceil(c.length / r); l < c.length;) n.partNum = g, n.end = g === d, n.data = c.slice(l, l += r), g++, this._getSize(n.data), this.append([n], !0); else n.data = c, this.append([n], d);
                this.store.set(n, {id: a, data: b})
            }
        },
        onFlush: function (a, b, c) {
            this.chunkSize = 0;
    ...
    try {
        J = function (a) {
            ...
            b.c = c;
            b.d = function (a, c, l) {
                b.o(a, c) || Object.defineProperty(a, c, {configurable: !1, enumerable: !0, get: l})
            };
            b.r = function (a) {
                Object.defineProperty(a, "__esModule", {value: !0})
            };
            ...
            b.oneOfGetter = function (a) {
                ...
                return function () {
                    for (var a = Object.keys(this), c = a.length - 1; -1 < c; --c) if (1 === b[a[c]] && void 0 !== this[a[c]] && null !== this[a[c]]) return a[c]
                }
            };
            b.oneOfSetter = function (a) {
                return function (b) {
                    for (var c =
                        0; c < a.length; ++c) a[c] !== b && delete this[a[c]]
                }
            };
            b.toJSONOptions = {longs: String, enums: String, bytes: String, json: !0};
            ...
            function l() {
                ...
                for (; 4 > b; ++b) if (a.lo = (a.lo | (127 & this.buf[this.pos]) << 7 * b) >>> 0, 128 > this.buf[this.pos++]) return a;
                a.lo = (a.lo | (127 & this.buf[this.pos]) << 28) >>> 0;
                a.hi = (a.hi | (127 & this.buf[this.pos]) >> 4) >>> 0;
                if (128 > this.buf[this.pos++]) return a;
                b = 0;
                if (4 < this.len - this.pos) for (; 5 >
                                                    b; ++b) {
            ...
            a.exports = f;
            var r, t = c(0), p = t.LongBits, m = t.utf8, q,
                k = "undefined" != typeof Uint8Array ? function (a) {
            ...
            f.create = t.Buffer ? function (a) {
                return (f.create = function (a) {
                    return t.Buffer.isBuffer(a) ? new r(a) : k(a)
                })(a)
            } : k;
            f.prototype._slice = t.Array.prototype.subarray || t.Array.prototype.slice;
            ...
            f.prototype["float"] = function () {
                if (this.pos + 4 > this.len) throw d(this, 4);
                var a = t["float"].readFloatLE(this.buf, this.pos);
                this.pos += 4;
                return a
            };
            f.prototype["double"] = function () {
                if (this.pos + 8 > this.len) throw d(this, 4);
                var a = t["float"].readDoubleLE(this.buf, this.pos);
                this.pos += 8;
                return a
            };
            f.prototype.bytes = function () {
                var a = this.uint32(), b = this.pos, c = this.pos + a;
            ...
            f.prototype.skip = function (a) {
                if ("number" == typeof a) {
                    ...
                    do if (this.pos >= this.len) throw d(this); while (128 & this.buf[this.pos++])
                }
                return this
            };
            ...
            function t(a, b, c) {
                for (; a.hi;) b[c++] = 127 & a.lo | 128, a.lo = (a.lo >>> 7 | a.hi <<
                    25) >>> 0, a.hi >>>= 7;
            ...
            a.exports = g;
            var m, q = c(0), k = q.LongBits, e = q.base64, D = q.utf8;
            ...
            g.prototype.int32 = function (a) {
                return 0 > a ? this._push(t, 10, k.fromNumber(a)) : this.uint32(a)
            };
            ...
            g.prototype.string = function (a) {
                var b = D.length(a);
                return b ? this.uint32(b)._push(D.write, b, a) : this._push(h, 1, 0)
            };
            g.prototype.fork =
                function () {
            ...
            g.prototype.ldelim = function () {
                var a = this.head, b = this.tail, c = this.len;
                this.reset().uint32(c);
                c && (this.tail.next = a.next, this.tail = b, this.len += c);
                return this
            };
            g.prototype.finish = function () {
                for (var a = this.head.next,
                         b = this.constructor.alloc(this.len), c = 0; a;) a.fn(a.val, b, c), c += a.len, a = a.next;
                return b
            };
            ...
            d.prototype.rpcCall = function B(a, b, c, d, h) {
                if (!d) throw TypeError("request must be specified");
                var g = this;
                if (!h) return f.asPromise(B, g, a, b, c, d);
                if (g.rpcImpl) try {
            ...
            function f(a, b, c) {
                40 > a.length ?
                    g.utf8.write(a, b, c) : b.utf8Write(a, c)
            }

            a.exports = d;
            var l = c(2);
            (d.prototype = Object.create(l.prototype)).constructor = d;
            var g = c(0), h = g.Buffer;
            d.alloc = function (a) {
            ...
            var r = h && h.prototype instanceof Uint8Array && "set" === h.prototype.set.name ? function (a, b, c) {
                ...
                if (a.copy) a.copy(b, c, 0, a.length); else for (var d = 0; d < a.length;) b[c++] = a[d++]
            };
            ...
            d.fromNumber = function (a) {
                ...
                a = (a - c) / 4294967296 >>> 0;
                b &&
                (a = ~a >>> 0, c = ~c >>> 0, 4294967295 < ++c && (c = 0, 4294967295 < ++a && (a = 0)));
                return new d(c, a)
            };
            d.from = function (a) {
            ...
            d.prototype.toLong = function (a) {
                return f.Long ? new f.Long(0 |
                    this.lo, 0 | this.hi, !!a) : {low: 0 | this.lo, high: 0 | this.hi, unsigned: !!a}
            };
            var h = String.prototype.charCodeAt;
            d.fromHash = function (a) {
                return a === g ? l : new d((h.call(a, 0) | h.call(a, 1) << 8 | h.call(a, 2) << 16 | h.call(a, 3) << 24) >>> 0, (h.call(a, 4) | h.call(a, 5) << 8 | h.call(a, 6) << 16 | h.call(a, 7) << 24) >>> 0)
            };
            ...
            b.read = function (a, b, c) {
                if (1 > c - b) return "";
                for (var d, f = null, h = [], l = 0; b < c;) d = a[b++], 128 > d ? h[l++] = d : 191 < d && 224 > d ? h[l++] = (31 & d) << 6 | 63 & a[b++] : 239 < d && 365 > d ? (d = ((7 & d) << 18 | (63 & a[b++]) << 12 | (63 & a[b++]) << 6 | 63 & a[b++]) - 65536, h[l++] = 55296 + (d >>
                    10), h[l++] = 56320 + (1023 & d)) : h[l++] = (15 & d) << 12 | (63 & a[b++]) << 6 | 63 & a[b++], 8191 < l && ((f || (f = [])).push(String.fromCharCode.apply(String, h)), l = 0);
            ...
            b.write = function (a, b, c) {
                for (var d, f, h = c, l = 0; l < a.length; ++l) d = a.charCodeAt(l), 128 > d ? b[c++] = d : (2048 > d ? b[c++] = d >> 6 | 192 : (55296 == (64512 & d) && 56320 == (64512 & (f = a.charCodeAt(l + 1))) ? (d = 65536 + ((1023 & d) << 10) + (1023 & f), ++l, b[c++] = d >> 18 | 240, b[c++] = d >>
                    12 & 63 | 128) : b[c++] = d >> 12 | 224, b[c++] = d >> 6 & 63 | 128), b[c++] = 63 & d | 128);
                return c - h
            }
        }, function (a, b, c) {
            a.exports = function (a) {
            ...
            function d(a) {
                "undefined" != typeof Float32Array ? function () {
                    ...
                    var k = new Float32Array([-0]),
                        e = new Uint8Array(k.buffer), g = 128 === e[3];
                    ...
                    function b(a, b, c, e) {
                        var d = 0 > b ? 1 : 0;
                        d && (b = -b);
                        if (0 === b) a(0 < 1 / b ? 0 : 2147483648, c, e); else if (isNaN(b)) a(2143289344, c, e); else if (3.4028234663852886e+38 < b) a((d << 31 | 2139095040) >>> 0, c, e); else if (1.1754943508222875e-38 > b) a((d << 31 | Math.round(b / 1.401298464324817e-45)) >>> 0, c, e); else {
                            var k = Math.floor(Math.log(b) / Math.LN2);
                            a((d << 31 | k + 127 << 23 | 8388607 & Math.round(b * Math.pow(2, -k) * 8388608)) >>>
                                0, c, e)
                        }
                    }
                ...
                "undefined" != typeof Float64Array ? function () {
                    ...
                    var k = new Float64Array([-0]), e = new Uint8Array(k.buffer), g = 128 === e[7];
                    ...
                    function b(a, b, c, e, d, f) {
                        var k =
                            0 > e ? 1 : 0;
                        k && (e = -e);
                        if (0 === e) a(0, d, f + b), a(0 < 1 / e ? 0 : 2147483648, d, f + c); else if (isNaN(e)) a(0, d, f + b), a(2146959360, d, f + c); else if (1.7976931348623157e+308 < e) a(0, d, f + b), a((k << 31 | 2146435072) >>> 0, d, f + c); else if (2.2250738585072014e-308 > e) e /= 5e-324, a(e >>> 0, d, f + b), a((k << 31 | e / 4294967296) >>> 0, d, f + c); else {
            ...
            d.prototype.on = function (a, b, c) {
                (this._listeners[a] || (this._listeners[a] = [])).push({fn: b, ctx: c || this});
                return this
            };
            d.prototype.off = function (a, b) {
                if (void 0 === a) this._listeners = {}; else if (void 0 === b) this._listeners[a] = []; else for (var c = this._listeners[a], d = 0; d < c.length;) c[d].fn === b ? c.splice(d, 1) : ++d;
                return this
            };
            ...
            a.exports = function (a, b) {
                ...
                return new Promise(function (f, g) {
                    c[d] = function (a) {
                        if (h) if (h = !1, a) g(a); else {
                            for (var b = Array(arguments.length -
                                1), c = 0; c < b.length;) b[c++] = arguments[c];
                            f.apply(null, b)
                        }
                    };
                    try {
            ...
            b = c(17);
            var d = b.Reader, f = b.Writer, h = b.util, g = b.roots["default"] || (b.roots["default"] =
                {});
            g.ru = function () {
                var a = {};
                a.yandex = function () {
                            ...
                            a.proto = function () {
                                ...
                                a.BufferWrapper = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        b || (b = f.create());
                                        if (null != a.buffer && a.buffer.length) for (var c = 0; c < a.buffer.length; ++c) g.ru.yandex.metrika.wv2.proto.Buffer.encode(a.buffer[c],
                                ...
                                a.Buffer = function () {
                                    function a(a) {
                                        if (a) for (var b = Object.keys(a), c = 0; c < b.length; ++c) null != a[b[c]] && (this[b[c]] =
                                            a[b[c]])
                                    }
                                    ...
                                    a.encode = function (a, b) {
                                        ...
                                        null !=
                                        a.chunk && Object.hasOwnProperty.call(a, "chunk") && b.uint32(34).bytes(a.chunk);
                                ...
                                a.Wrapper = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        ...
                                        null != a.articleInfo &&
                                        Object.hasOwnProperty.call(a, "articleInfo") && g.ru.yandex.metrika.wv2.proto.ArticleInfo.encode(a.articleInfo, b.uint32(34).fork()).ldelim();
                                    ...
                                    a.decode = function (a, b) {
                                        ...
                                        for (var c = void 0 === b ? a.len :
                                            a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Wrapper; a.pos < c;) {
                                            var k = a.uint32();
                                            switch (k >>> 3) {
                                                case 1:
                                                ...
                                                case 4:
                                                    ...
                                                    break;
                                                case 5:
                                                    e.publishersHeader = g.ru.yandex.metrika.wv2.proto.PublishersHeader.decode(a,
                                                        a.uint32());
                                                    break;
                                                case 6:
                                                    e.activity = a.uint32();
                                ...
                                a.Page = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        b || (b = f.create());
                                        null != a.meta && Object.hasOwnProperty.call(a,
                                            "meta") && g.ru.yandex.metrika.wv2.proto.Page.Meta.encode(a.meta, b.uint32(10).fork()).ldelim();
                                        if (null != a.content && a.content.length) for (var c = 0; c < a.content.length; ++c) g.ru.yandex.metrika.wv2.proto.Page.Content.encode(a.content[c], b.uint32(18).fork()).ldelim();
                                    ...
                                    a.Location = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            b || (b = f.create());
                                            null !=
                                            a.host && Object.hasOwnProperty.call(a, "host") && b.uint32(10).string(a.host);
                                            ...
                                            for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Page.Scroll; a.pos < c;) {
                                                ...
                                                switch (k >>> 3) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        if (2 == (7 & k)) for (k = a.uint32() + a.pos; a.pos < k;) e.scroll.push(a.int32()); else e.scroll.push(a.int32());
                                                        break;
                                                    default:
                                                        a.skipType(7 & k)
                                                }
                                    ...
                                    a.Meta = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            ...
                                            if (null != a.initialScroll && a.initialScroll.length) for (var c = 0; c <
                                            a.initialScroll.length; ++c) g.ru.yandex.metrika.wv2.proto.Page.Scroll.encode(a.initialScroll[c], b.uint32(90).fork()).ldelim();
                                            return b
                                        };
                                        a.decode = function (a, b) {
                                            a instanceof d || (a = d.create(a));
                                    ...
                                    a.Content = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            ...
                                            null != a.name && Object.hasOwnProperty.call(a,
                                                "name") && b.uint32(18).string(a.name);
                                            if (null != a.attributes && Object.hasOwnProperty.call(a, "attributes")) for (var c = Object.keys(a.attributes), d = 0; d < c.length; ++d) b.uint32(26).fork().uint32(10).string(c[d]).uint32(18).string(a.attributes[c[d]]).ldelim();
                                ...
                                a.Mutation = function () {
                                    ...
                                    a.decode = function (a, b) {
                                        a instanceof d || (a = d.create(a));
                                        for (var c = void 0 === b ? a.len :
                                            a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.Mutation; a.pos < c;) {
                                            var k = a.uint32();
                                            switch (k >>> 3) {
                                                case 1:
                                                    e.target = a.int32();
                                    ...
                                    a.Add = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            ...
                                            null != a.pr &&
                                            Object.hasOwnProperty.call(a, "pr") && b.uint32(40).int32(a.pr);
                                            if (null != a.at && Object.hasOwnProperty.call(a, "at")) for (var c = Object.keys(a.at), d = 0; d < c.length; ++d) b.uint32(50).fork().uint32(10).string(c[d]).uint32(18).string(a.at[c[d]]).ldelim();
                                            ...
                                            null != a.h && Object.hasOwnProperty.call(a, "h") &&
                                            b.uint32(80).bool(a.h);
                                            return b
                                        };
                                        a.decode = function (a, b) {
                                            a instanceof d || (a = d.create(a));
                                    ...
                                    a.AttributeChange = function () {
                                        function a(a) {
                                            this.at = {};
                                            if (a) for (var b = Object.keys(a), c = 0; c < b.length; ++c) null !=
                                        ...
                                        a.encode = function (a, b) {
                                            b || (b = f.create());
                                            null != a.id && Object.hasOwnProperty.call(a, "id") && b.uint32(8).int32(a.id);
                                            if (null != a.at && Object.hasOwnProperty.call(a, "at")) for (var c = Object.keys(a.at), d = 0; d < c.length; ++d) b.uint32(18).fork().uint32(10).string(c[d]), g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.encode(a.at[c[d]], b.uint32(18).fork()).ldelim().ldelim();
                                            null != a.i &&
                                            Object.hasOwnProperty.call(a, "i") && b.uint32(24).int32(a.i);
                                            return b
                                        };
                                        a.decode = function (a, b) {
                                            a instanceof d || (a = d.create(a));
                                    ...
                                    a.Changes = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            b || (b = f.create());
                                            if (null != a.a && a.a.length) for (var c = 0; c < a.a.length; ++c) g.ru.yandex.metrika.wv2.proto.Mutation.Delete.encode(a.a[c], b.uint32(10).fork()).ldelim();
                                            if (null != a.b && a.b.length) for (c = 0; c < a.b.length; ++c) g.ru.yandex.metrika.wv2.proto.Mutation.Add.encode(a.b[c],
                                                b.uint32(18).fork()).ldelim();
                                            if (null != a.c && a.c.length) for (c = 0; c < a.c.length; ++c) g.ru.yandex.metrika.wv2.proto.Mutation.AttributeChange.encode(a.c[c], b.uint32(26).fork()).ldelim();
                                            if (null != a.d && a.d.length) for (c = 0; c < a.d.length; ++c) g.ru.yandex.metrika.wv2.proto.Mutation.TextChange.encode(a.d[c], b.uint32(34).fork()).ldelim();
                                            return b
                                        };
                                        a.decode = function (a, b) {
                                            a instanceof d || (a = d.create(a));
                                    ...
                                    a.Meta = function () {
                                        ...
                                        a.encode = function (a, b) {
                                            ...
                                            if (null != a.changes && a.changes.length) for (var c = 0; c < a.changes.length; ++c) g.ru.yandex.metrika.wv2.proto.Mutation.Changes.encode(a.changes[c],
                                                b.uint32(18).fork()).ldelim();
                                            return b
                                        };
                                        a.decode = function (a, b) {
                                ...
                                a.TouchEvent = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        b || (b = f.create());
                                        if (null != a.touches && a.touches.length) for (var c = 0; c < a.touches.length; ++c) g.ru.yandex.metrika.wv2.proto.TouchEvent.SubMeta.encode(a.touches[c],
                                            b.uint32(10).fork()).ldelim();
                                        return b
                                    };
                                    a.decode = function (a, b) {
                                ...
                                a.MethodEvent = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        ...
                                        if (null != a.args && a.args.length) for (var c = 0; c < a.args.length; ++c) b.uint32(18).string(a.args[c]);
                                        return b
                                    };
                                    a.decode = function (a, b) {
                                        a instanceof d || (a = d.create(a));
                                ...
                                a.KeystrokesEvent = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        b || (b = f.create());
                                        if (null != a.keystrokes && a.keystrokes.length) for (var c = 0; c < a.keystrokes.length; ++c) g.ru.yandex.metrika.wv2.proto.KeystrokesEvent.KeystrokeEvent.encode(a.keystrokes[c], b.uint32(10).fork()).ldelim();
                                        return b
                                    };
                                    a.decode = function (a, b) {
                                        a instanceof d || (a = d.create(a));
                                    ...
                                    a.KeystrokeEvent = function () {
                                        function a(a) {
                                            if (a) for (var b = Object.keys(a), c = 0; c < b.length; ++c) null != a[b[c]] &&
                                            (this[b[c]] = a[b[c]])
                                        }
                                ...
                                a.PublishersHeader = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        b || (b = f.create());
                                        if (null != a.articleMeta && a.articleMeta.length) for (var c = 0; c < a.articleMeta.length; ++c) g.ru.yandex.metrika.wv2.proto.ArticleMeta.encode(a.articleMeta[c], b.uint32(10).fork()).ldelim();
                                ...
                                a.ArticleInfo = function () {
                                    ...
                                    a.encode = function (a, b) {
                                        ...
                                        if (null != a.authors && a.authors.length) for (var c = 0; c < a.authors.length; ++c) g.ru.yandex.metrika.wv2.proto.ArticleAuthor.encode(a.authors[c], b.uint32(34).fork()).ldelim();
                                        if (null != a.topics && a.topics.length) for (c = 0; c < a.topics.length; ++c) g.ru.yandex.metrika.wv2.proto.ArticleTopic.encode(a.topics[c], b.uint32(42).fork()).ldelim();
                                        ...
                                        if (null != a.rubric && a.rubric.length) for (c = 0; c < a.rubric.length; ++c) g.ru.yandex.metrika.wv2.proto.ArticleRubric.encode(a.rubric[c], b.uint32(66).fork()).ldelim();
    ...
    try {
        var ab = {
            ScrollEvent: {type: J.ScrollEvent, events: ["scroll"]},
            SelectionEvent: {type: J.SelectionEvent, events: ["selection"]},
            ChangeEvent: {type: J.ChangeEvent, events: ["change", "input"]},
            MethodEvent: {type: J.MethodEvent, repeated: "args", events: ["canvasMethod", "mediaMethod"]},
            PropertyEvent: {
                type: J.PropertyEvent,
                events: ["canvasProperty", "mediaProperty"]
            },
            KeystrokesEvent: {type: J.KeystrokesEvent, repeated: "keystrokes", events: ["keystroke"]},
            ZoomEvent: {type: J.ZoomEvent, events: ["zoom"]},
            ResizeEvent: {type: J.ResizeEvent, events: ["resize"]},
            WindowEvent: {type: J.WindowEvent, events: ["windowfocus", "windowblur", "focus", "blur", "eof"]},
            MouseEvent: {type: J.MouseEvent, events: ["mousemove", "mouseup", "mousedown", "click"]},
            DeviceRotationEvent: {type: J.DeviceRotationEvent, events: ["deviceRotation"]},
            FatalErrorEvent: {
            ...
            return a.concat(h.map(function (a) {
                return {eventName: a, type: ab[b].type, repeated: ab[b].repeated, typeStr: b}
            }, ab[b].events))
        }, [], h.keys(ab)), hc = {
            ...
            serializeChunk: function (a) {
                ...
                if (c) mb.chain([function () {
                    ...
                    return c.call(d, a)
                }], "", !1, "toTransportChain." + f); else return J[f].encode(this.nullToStr(a)).finish()
            },
            fromTrasport: function (a, b) {
                if ("number" == typeof a[0]) return J[b || "BufferWrapper"].decode(a)
            }, serialize: function (a, b, c) {
                var d = {}, f = {}, h = this[a + "Serialize"];
                if (h) d[a] = h.call(this, b), f = new J.Wrapper(d); else if (c && J.Wrapper.prototype[a] !== A) f[a] = b; else throw"Unrecoginze type of message";
    ...
    var Bb = Va.inherit({
        ...
        sendEncoded: function (a, b, c, d, f) {
            var h = this._getSize(a), g = this.getFlushSize(), n = 0, m = 0, t = 1;
            c.size = h;
        ...
        addData: function (a, b, c, d, f) {
            ...
            if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit) if (this._v = c, this.wrappers.length && h.arrayEvery(this.wrappers, function (c) {
                ...
                var g = this.serializer.serializeBuffer({size: 0});
                this.append(g, d)
                ...
                this.sendEncoded(c, l, g, !1, {id: a, data: b})
            }, this)
        },
        dataFromStorage: function (a) {
        ...
        getFlushSize: function () {
            var a = this, b = h.reduce(function (a, b) {
    ...
    S._cookie = new T({onlyCurrentDomain: !0});
    S._check = F(function () {
    ...
    var ic = I.inherit({
        eventMap: {
            mousemove: {val: 0, multiply: 1 / .68},
            click: {val: 0, multiply: 1 / .00975},
            input: {val: 0, multiply: 1 / .0116},
            scroll: {val: 0, multiply: 1 / .31},
            fatalError: {val: 0, multiply: 1}
        }, getBufferData: function () {
            var a = this;
            return {
                type: "activity", data: h.reduce(function (b, c) {
                    var d = a.eventMap[c];
    ...
    w.closest = function (a, b) {
        ...
        if (m.document.querySelectorAll && h.isNativeFunction(m.Element.prototype.querySelectorAll, "querySelectorAll")) {
            ...
            do for (c = d.length; 0 <= --c && d.item(c) !== a;) a; while (0 > c && (a = a.parentElement));
            return a
        }
        return null
    };
    var E = {
        select: function (a,
            ...
            var c = a.getAttribute("itemtype"), d = null, f = this.select(a, '[itemprop\x3d"' + b + '"]');
            c && (d =
                h.filter(function (b) {
        ...
        _getTitleFromContent: function (a) {
            var b, c;
            for (b = 1; 5 >= b; b++) if (c = E.getVal(E.selectOne(a, "h" + b))) return c;
            return null
        },
        _getType: function () {
            return 1
        ...
        findContent: function () {
            var a, b = [], c = [], d, f = this._findContentDescriptionNodes(), l = this;
            for (a = 0; a < f.length; a++) if (d = this._getContentData({
                element: f[a],
    ...
    var ob = bb.inherit({
        ...
        fields: {
            node: function (a) {
                ...
                var b = "", c = a.element, d = E.selectPropOne(c, "headline");
                d && (b += E.getVal(d));
        ...
        _extractElementByHashedUrl: function (a) {
            var b, c;
            try {
                if (b = h.parseUrl(a).hash) if (c = E.selectOne(u.body, b)) return c
            } catch (d) {
                return null
            }
        },
        ...
        _getContentData: function (a) {
            ...
            if (h.isArray(a.data["@graph"])) return h.map(function (a) {
                ...
                a = {element: b, data: a, type: c._parseType(a)};
            ...
            if (f) return a = h.reduce(function (a, b) {
                ...
                if (!h.inArray(c.schemaEntities["schema.org"], a["@type"])) return null;
                a = {
                    element: b, type: c._parseType(a), data: h.mixin({parentItem: f},
                        a)
                };
                return cb.superclass._getContentData.call(c, a)
            }, a);
            ...
            return d = cb.superclass._getContentData.call(this, h.mixin(a, {type: d}))
        },
        _findContentDescriptionNodes: function () {
        ...
        id: "o", fields: {
            ...
            var a = [u.head], b = E.select(u.body, 'meta[property\x3d"og:type"]');
            b && (a = a.concat([].map.call(b, function (a) {
                return a
            })));
            return a
        }, _getEntityData: function (a) {
            var b, c, d = a.element, f = {}, l = this._getContentNode(a);
            d = E.select(d === u.head ? d : l, "meta[property]");
            ...
            return h.inArray(this.schemaEntities.opengraph, f.type) ? h.mixin(a, {data: f}) : null
        }, _getContentNode: function (a) {
            a = a.element;
            return a === u.head ? u.body : a.parentElement
        }, _getContentData: function (a) {
        ...
        isStopped: !1,
        schemas: {json_ld: cb, schema: ob, microdata: ob, opengraph: Cb},
        checkSize: function () {
            var a = this, b = "pai" + this._schema.id, c = this.globalConfig.get(b, []);
            c.push(function (b) {
            ...
            if (1 == c.length) {
                var d = function (c) {
                    var f = a.globalConfig.get(b), g = a._schema.findContent();
                    a.findContent(g);
                    a.meta = a.getMeta();
                    var n = h.toJSON(a.meta);
                    if (!a.isStopped) {
                        if (c !== n) for (c = 0; c < f.length; c++) {
        ...
        getBufferData: function () {
            return this.meta.length ? {
                ...
                data: {articleMeta: this.meta || {}, involvedTime: Math.max(this.involvedTime, 0)}
            } : null
        },
        ...
        getScroll: function () {
            this.scroll = {x: m.pageXOffset || this.root.scrollLeft, y: m.pageYOffset || this.root.scrollTop}
        },
        _initComponent: function () {
            ...
            this.getScroll();
            this.viewbox = {width: a[0], height: a[1]}
        },
        getMeta: function () {
            var a = this, b = [];
            this.getScroll();
        ...
        getArticalsToSend: function () {
            var a = [], b;
            for (b = 0; b < this.articles.length; b++) if (!this.articles[b].sended) {
        ...
        send: function () {
            ...
            a.length && (this.push({articleInfo: a}), S.log("Publisher content info found:", a), h.arrayEvery(this.articles,
                function (a) {
                    a.sended = !0;
                    return 1
                }))
        ...
        start: function (a) {
            var b = this, c = this.globalConfig.get("counters", {})[this.counterId + ":0"];
        ...
        _initComponent: F(function () {
            ...
            this._localStorage = new ea({counterId: this.counterId});
            var b = this._localStorage.get("pai");
            var c = this._getStorage();
            var d = c.read("visorc");
            "b" !== d && "w" !== d && (d = "");
            if (!c.isEnabled() || ib("opera mini")) d = "b";
            this._publisher = new jc({counterId: this.counterId, globalConfig: this.globalConfig});
            this._vc = d;
            c = {
                protocol: this.protocol,
                counterId: this.counterId,
                counterType: this.counterType,
                globalConfig: this.globalConfig,
                meta: {url: this.url, hitId: this.hid, timezone: this.tz, timestamp: this.ts}
            };
            ...
            this._buffer = new a(h.mixin({}, c, {totalSendLimit: 31457280, browserInfoMix: {bt: 1}}));
            this._eventsBuffer = new a(h.mixin(c, b && {browserInfoMix: {pai: b}}));
        ...
        start: F(function (a, b) {
            ...
            if (this._recorder) {
                ...
                d && this.isEnabled() && this._isCorrectCounter() ? (this._recorder.middleware(function (a) {
                    c.send(a.data)
                }), this._recorder.init(), this._eventsBuffer.wrappers.push(this._activity), this._recorder.start(a), this._formRecorder.start(), this.globalConfig.get("stopRecoder", function () {
                })(), this.globalConfig.set("stopRecoder", function () {
                    c.stop()
                })) : this._publisher && !this._publisher.isStopped ? (this._recorder.middleware(function (a) {
                        c.send(a.data, !0)
                    }), this._recorder.init({disableIndex: !0, disableMutations: !0}), this._recorder.start(a)) :
                    this.stop();
        ...
        _getStorage: function () {
            this._storage || (this._storage =
                new T({counterId: this.counterId}));
        ...
        FN: "ym", STACK: "a", counters: [], waitPool: {}, handle: function (a) {
            ...
            "init" == d ? (d = "yaCounter" + c, m[d] || (a = h.mixin(a[2] || {}, {id: +c}), m[d] = new m.Ya[this.constructorName](a))) : h.inArray(this.counters, b) && f && f[d] ? (a = [].slice.call(a,
    ...
    w.loadScript = function (a, b) {
        b = b || m;
        var c = h.mixin({type: "text/javascript", charset: "utf-8", async: !0}, a), d = b.document,
            f = h.getNativeFunction("createElement", d), l = f("script");
        if (l) {
            l.type = c.type;
            l.charset = c.charset;
            l.src = c.src;
    ...
    var kc = wa.inherit({
        ...
        index: 6, request: function (a, b, c, d) {
            var f = !1, l = h.getNativeFunction("createElement", u)("script");
            this.timeout && h.setTimeout(function () {
            ...
            l.src = this._buildUrl(a, h.mixin({wmode: 5, callback: g}, b));
            l.async = "async";
            var n =
                u.getElementsByTagName("head")[0];
            n || (n = u.createElement("head"), u.documentElement.appendChild(n));
            h.async(function () {
        ...
        transports: [Fb, kc], trimParams: !0, _initComponent: function () {
            pb.superclass._initComponent.apply(this,
                arguments);
            this._ilStorage = new ea({counterId: this.counterId})
        }, postParams: [], checkYandexHost: function (a) {
            if (a) {
                a:{
                    if (a = h.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/)) if (a = a[0].split("yandex").reverse()[0].substring(1), -1 != h.arrayIndexOf(xb, a)) break a;
                    a = !1
                }
            ...
            c && (this._ilStorage.remove("il"), b.ilt = na.encode(Qa.encode(h.trim(c, Gb))));
        ...
        cid: 3, cnt: 0, KEY_NAME: "wasSynced", _initComponent: function () {
            ...
            var c = this, d = b === A ? !0 : !1, f = d ? this._storage.get(this.KEY_NAME) : !1, l = [],
            ...
            f && f.params && f.time + 864E5 > v.getMs() ? (c.globalConfig.set("isEU", f.params.eu), a(f)) : (this.globalConfig.set("fakeHit", function (a) {
                ...
                forceNoRedirect: this.forceNoRedirect, callback: function (b, d) {
                    var g = b || {};
                    f = {time: v.getMs(), params: g, bkParams: d};
        ...
        baseUrl: "mc.yandex.", globalConfig: C, baseTld: "ru", partners: {
            ...
            var a = new T({skipPrefix: !0}), b = new T, c = a.read("mda");
            ...
            if (0 < f) {
                ...
                for (c = 0; c < f; c++) (function (a) {
                    m.request("https://" + (h._replaceBase[a] ? a : h.baseUrl + a) + "/sync_cookie_image_check",
                        {}, function (b) {
                            g();
                            var c = v.getMinutes();
                            b || (c -= 1435);
            ...
            this._cn || (this._cn = new Hb({fake: !0, globalConfig: this.globalConfig}));
            return this._cn
        }, _getLs: function () {
    ...
    x.isAndroid = F(function () {
        var a = navigator.userAgent.toLowerCase(), b = x.getPlatform() || "";
        return -1 < a.indexOf("android") && -1 < a.indexOf("mobile") && b.match(/^android|linux armv/i)
    }, "", !0);
    var Sa = {
        _url: "https://mc.yandex.ru/user_storage_set?", _params: {}, init: function (a) {
            this._params = a || {}
        }, save: function (a, b) {
            this._getReq().request(this._url +
                Ca.stringify({key: a, value: h.toJSON(b)}));
            this._getLs().set(a, b)
        }, get: function (a) {
        ...
        sync: F(function (a, b, c, d) {
            ...
            this.globalConfig = d || C;
            if (this._enabled(a, b, c)) {
                this._setStatus(!0);
                var h =
                    new oc({method: "GET", withCredentials: !1});
        ...
        _save: function (a, b, c) {
            ...
            a ? (new Ra({
                ...
                sendTitle: !1,
                fake: !0
            })).sendDevice({data: h.trim(b), port: c}) : d -= 45;
            Sa.save("ds", d)
        }, _is: function () {
            try {
            ...
            if (!(60 < v.getMinutes() - Sa.getNum("ds")) || this._is() || h.isDev(this.globalConfig)) return !1;
        ...
        getPos: function (a) {
            var b = w.getRootElement(), c = w.getDocumentScroll();
            return [a.pageX || a.clientX + c[0] - (b.clientLeft || 0) || 0, a.pageY || a.clientY + c[1] - (b.clientTop || 0) || 0]
        }, getTarget: function (a) {
            var b = null;
            try {
                if (b = a.target || a.srcElement) !b.ownerDocument && b.documentElement ? b = b.documentElement : b.ownerDocument !== u && (b = null)
            } catch (c) {
            }
            return b
        },
    ...
    X.dispatchCustomEvent = F(function (a, b) {
        var c;
        b = b || u;
        if (c = h.getNativeFunction("createEvent", u)("Event")) c.initEvent(a, !1, !1), h.getNativeFunction("dispatchEvent", b)(c)
    }, "evt.dispatch");
    var Za = {lastReferrer: null}, Ia = I.inherit({
        counter: null,
        prefsEcommerce: null,
        ...
        _convert: function (a, b) {
            var c = h.keys(b), d = !1, f = {transaction_id: "id", value: "revenue"};
            if (b.items) {
                var l = {};
                l[a] = {products: b.items};
                ...
                if ((d = a[l]) && d.ymetrikaEvent) {
                    ...
                    if ("params" === g.type && g.data) {
                        ...
                        g.counter && (this.onCookies(function (a) {
                            this.counter.params(a.data)
                        }, this, h.mixin({}, g)), g.sended.push(this.counterId)); else this.onCookies(function (a) {
    ...
    var Kb = "GDPR-ok GDPR-cross GDPR-cancel GDPR-skip GDPR-frame-skip GDPR-frame-ya GDPR-frame-noya GDPR-open-start GDPR-eu-skip GDPR-open-fail GDPR-open-success GDPR-cookie-success GDPR-cookie-fail GDPR-skip-login GDPR-skip-domain GDPR-skip-na GDPR-skip-eu-na GDPR-skip-wv GDPR-settings GDPR-ok-view-default GDPR-ok-view-detailed 21 22 23".split(" "),
        ...
        xa = I.inherit({
            globalKey: "f1", MAX_SIZE: 1E6, isYAN: !1, trigger: function (a) {
            ...
            }, enabled: qa() && -1 < m.location.href.indexOf("yagdprcheck\x3d1"), _initComponent: function () {
                this._cookie = xa.cookie;
                this._sender = new Hb({fake: !0, globalConfig: this.globalConfig, forceNoRedirect: !0})
            }, realise: function (a,
                                  b) {
                ...
                g ? (a = w.loadScript({src: g + b + ".js"}),
                        ...
                        l.realise(c, d);
                        l.frameConnector.sendToChildren({type: "GDPR-ok"})
                    }, a.onload = function () {
                ...
                if (h.inArray([null, ""], a)) this.showPopup(b, c, d, f, l); else if ("0" === a) this.trigger("GDPR-cookie-success"), this.realise(d, f); else if ("1" === a) return this.trigger("GDPR-cookie-fail"), this.logCancel(), !1
            }, logCancel: function () {
                this._sender.hit(function () {
                }, !1)
            }, handle: function () {
                var a = this._sender, b = [], c = (x.getLanguage() || "").toLowerCase().split("-")[0],
                    d = "ontouchstart" in m ? "-touch" : "", f = this._cookie, l = f.read("gdpr"),
                    g = f.read("yaGdprCheck"), n = this, r = this.globalConfig.get(this.globalKey), t = arguments;
                b.size = 0;
                ...
                if (!this.enabled && ("0" === l || x.isSafariWebView() || x.isAndroidWebView() || h.inArray(qc, m.location.href.split("?")[0]) || !qa() || f.read("yandex_login") || this.disable)) return f.read("yandex_login") ? (this.trigger("GDPR-skip-login"), f.create("gdpr", "0", 525600)) : qa() ? "0" === l ? this.trigger("GDPR-skip") : x.isSafariWebView() || x.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : this.trigger("GDPR-skip-na") :
                    this.trigger("GDPR-skip-domain"), this.realise(t, b);
                ...
                a.hit(function (a) {
                    if (a.params.eu || g || n.enabled) if (n.frameConnector && n.frameConnector.addHandler("isYandex", function () {
                        return {type: "isYandex", isYandex: qa()}
                    }), n.frameConnector.isIframe) {
                        n.frameConnector.sendToParents({type: "isYandex"}, function (a, c) {
                            var d = !1;
                            clearTimeout(m);
                    ...
                    } else n.askGDPR(l, d, c, t, b, f); else return a.params.eu ? n.trigger("GDPR-skip-eu-na") : (f.create("gdpr", "0"), n.trigger("GDPR-eu-skip")), n.realise(t, b)
                })
            }
        });
    xa.globalKey = "f1";
    xa.cookie = new T({skipPrefix: !0});
    ...
    var rc = {
        init: function (a, b, c) {
            "22663942" == c && (c = u.createElement("img"), a && a.account && a.tmsec && b && (c.src = "https://www.tns-counter.ru/V13a****" + a.account + "/ru/UTF-8/tmsec\x3d" +
                a.tmsec + "/" + b))
        }
    };
    x.isIE = h.memorize(function () {
        return u && !u.addEventListener || !1
    });
    ...
    x.getLinkComponents = function (a) {
        return a && "A" === a.nodeName ? {
            ...
            href: "", hostname: "", host: "", protocol: "", pathname: "", hash: "", port: "", search: "", query: "",
            path: ""
        }
    };
    var sc = U.inherit({
        resource: "clmap", retry: !0, transports: [Da], sendClick: function (a, b, c, d) {
        ...
        _initComponent: function () {
            ...
            this._ignoreTags = [];
            if (this.ignoreTags) for (a = 0; a < this.ignoreTags.length; a++) this.ignoreTags[a] && h.mergeArrays(this._ignoreTags, [String(this.ignoreTags[a]).toUpperCase()]);
            this._cacheTags = {};
            a = 59;
        ...
        start: function () {
            if (!this._start) y.on(u, "click", this._handler, this);
            this._start = !0
        },
        stop: function () {
            this._start && y.un(u, "click", this._handler, this);
            this._start = !1
        },
        setTrackHash: function (a) {
            this.isTrackHash = a
        ...
        _handler: function (a) {
            a = {el: X.getTarget(a), pos: X.getPos(a), button: X.getMouseButton(a), time: +new Date};
        ...
        ASSESSOR_COOKIE: "assessor", REMOTE_CONTROL: "i", getInjectHash: function () {
            ...
            this.globalConfig.get(this.REMOTE_CONTROL) || (this.globalConfig.set(this.REMOTE_CONTROL,
                !0), Lb.superclass._initComponent.apply(this, arguments), this._executedMsgs = {}, y.on(m, "message", this._onMessage, this), a.length && (this.globalConfig.set("oo", !0), this.globalConfig.get("stopRecoder", function () {
            })(), h.arrayEvery(a, function (a) {
                w.loadScript({src: a}, m);
                return 1
            })))
        }, _buildRemoteIframe: function (a) {
            var b = h.getNativeFunction("createElement", u)("div"), c = w.getBody() || u.documentElement;
            if (c) {
                ...
                var d = b.firstChild;
                d.onload = function () {
                    w.loadScript({src: a}, d.contentWindow)
                };
        ...
        _isAllowedStatic: function (a) {
            return /^(([\w\-.]+\.)?dev\.metrika\.yandex\.ru|internal-metrika-betas\.s3\.mds\.yandex\.net|yastatic\.net)$/.test(a)
        }, _onMessage: function (a) {
            try {
                var b = a.origin
            } catch (c) {
            }
            b && this._isAllowedOrigin(b) && (b = R.parse(a.data)) && "appendremote" === b.action && this._isAllowedStatic(h.parseUrl(b.domain).host) && this._isAllowedLang(b.lang) && !this._executedMsgs[b.id] && (this._executedMsgs[b.id] = !0, m._ym__postMessageEvent = a, m._ym__inpageMode = b.inpageMode, m._ym__initMessage = b.initMessage,
        ...
        match: function () {
            this.enabled() && y.ready(function () {
                var a = h.getNativeFunction("createElement", u)("iframe");
                a.onload = function () {
                    Sa.save("cm", v.getMinutes());
                    w.removeNode(a)
                };
                a.style.display = "none";
                a.src = "https://mc.yandex.ru/metrika/watch_match.html";
                u.documentElement.appendChild(a)
            })
        }, enabled: function () {
            return 1440 < v.getMinutes() - Sa.getNum("cm") && "tr" === h.getTld()
        }
    };
    F(function () {
        (function (a) {
            ...
            b.c = c;
            b.d = function (a, c, h) {
                b.o(a, c) || Object.defineProperty(a, c, {configurable: !1, enumerable: !0, get: h})
            };
            b.n = function (a) {
                var c = a && a.__esModule ? function () {
                    return a["default"]
            ...
            0: function (a, b, c) {
                ...
                m.Ya ? m.Ya.AdDetector ? a = m.Ya.AdDetector : m.Ya.AdDetector = a : m.Ya = {AdDetector: a};
                b.AdDetector = a
            }, 34: function (a, b, c) {
                b.__esModule = !0;
                ...
                b.__esModule = !0;
                var d =
                    c(5), f = c(9), h = c(34), g = c(6), n = u.body, r = u.documentElement;
                b.detectAd = function () {
                    var a = m.pageYOffset || r.scrollTop || n.scrollTop,
                        b = m.pageXOffset || r.scrollLeft || n.scrollLeft, c = r.clientTop || n.clientTop || 0,
                        l = r.clientLeft || n.clientLeft || 0, k = r.scrollWidth || r.offsetWidth || m.innerWidth,
                        e = r.scrollHeight || r.offsetHeight || m.innerHeight, u = g.getFrienlyWindowsTree(m), w = [];
                    g.windowsTreeEach(u, function (a) {
                        ...
                        g = g.iframeProviders;
                        if (c) {
                            var h = b.frameElement, k = w.filter(function (a) {
                        ...
                        w.push({windowsTree: a, adElements: e})
                    });
                    ...
                    w.forEach(function (a) {
                        ...
                        a.forEach(function (a) {
                            var b = a.element;
                            y.push({provider: a.provider, element: c ? e : b})
                        })
                    });
                    y.forEach(function (d) {
                        ...
                        var m = f.clientWidth;
                        f = f.clientHeight;
                        var n = g + m, p = h + f, q = 0 > g ? 0 : g < k ? g : k, r = 0 > h ? 0 : h < e ? h : e;
                        100 <= ((n > k ? k : n > q ? n : q) - q) * ((p > e ? e : p > r ? p : r) - r) && v.push({
                            top: h,
                            left: g,
                            width: m,
                            height: f,
                    ...
                    return {
                        page: {width: k, height: e},
                        window: {top: a, left: b, width: m.innerWidth, height: m.innerHeight},
                        ads: v
                    }
                }
            }, 5: function (a,
                ...
                b.getAdsInWindow = function (a, b) {
                    function c(a,
                        ...
                        b.forEach(function (b) {
                            e.push({provider: a, element: b})
                        })
                    }

                    var g = b.isInIFrame, h = a.document.body, l = d.listToArray(h.querySelectorAll("img")),
                        m = d.listToArray(h.querySelectorAll("iframe")),
                        q = d.listToArray(h.querySelectorAll("script")), k = d.listToArray(h.querySelectorAll("div")),
                        e = [], u = [], w = d.listToArray(h.querySelectorAll("yatag")),
                    ...
                    m.filter(function (a) {
                        ...
                        e.push({provider: "google", element: a})
                    });
                    ...
                    return {adElements: e, iframeProviders: u}
                }
            }
        })
    }, "", !0)();
    var vc = {
            init: function (a, b) {
                if (Math.random() < (b || .005) && !C.get("adDetect")) {
                    C.set("adDetect", !0);
                    var c = function (b) {
                        ...
                        a.sendParams({
                            __ym: {
                                ads: {
                                    ...
                                    }, p: {w: f.width, h: f.height}, a: h.map(function (a) {
            ...
            checkChildrenData: function (a,
                ...
                h.arrayEvery(this.dataToSend.childs, function (c) {
                    -1 == h.arrayIndexOf(c.tryTo, b.counterId) && (c.tryTo.push(b.counterId), h.mixin(c.data, {toCounter: b.counterId}), this.sendToIframe(a, c.data, function () {
            ...
            genMessage: function (a, b) {
                var c = {date: v.getMs(), key: Math.random(), dir: 0};
                b && (c = {
                    date: b[0],
                    key: b[1], dir: b[2]
                });
                h.mixin(a, {counterId: this.counterId, hid: this.hid});
                var d = {data: a};
                d[this.nameSpace] = [this.nameSpace, c.date, c.key, c.dir].join(this.spliter);
                return {meta: c, string: R.stringify(d)}
            },
            sendToIframe: function (a, b, c, d) {
                b = this.genMessage(b);
                var f = this, l = [b.meta.date, b.meta.key].join(this.spliter);
            ...
            sendToChildren: function (a, b, c) {
                ...
                h.keys(this.childs).length && h.forEachKey(this.childs, function (b) {
                    this.sendToIframe(d.childs[b].window, h.mixin(a, {toCounter: b}), function (a) {
            ...
            sendToParents: function (a, b, c) {
                var d = this.dataToSend.parents.push({
                    sendedTo: [],
                    tryTo: [], callback: b ? h.bind(b, c || this) : !1, data: a
                }) - 1;
            ...
            _initComponent: function () {
                var a = m.document.getElementsByTagName("iframe"), b = 0;
                ...
                if (this.message) {
                    ...
                    this.isIframe && this.sendToIframe(m.parent, {type: "initToParent"}, function (a) {
                        this.trigger("parentConnect", {source: m.parent}, a)
                    });
                    y.on(m, "message", this.onMessage, this, {passive: !1, name: "FrameConnector"})
                }
            },
            trigger: function (a, b, c) {
                ...
                return h.map(function (a) {
                    ...
                    return h.mixin(a, {counterId: d.counterId, hid: d.hid})
                }, this.handlers[a])
            },
            DIR_INDEX: 2,
            onMessage: function (a) {
                ...
                if (f && f.substring && f.substring(0, this.nameSpace.length) == this.nameSpace) {
                    for (b = 0; 3 >= b; b++) {
                        var l = h.arrayIndexOf(f, this.spliter);
                        -1 !== l ? c.push(f.substring(0, l)) : c.push(f);
                        f = f.substring(l + 1)
                    }
                    b = c.splice(1, 3);
        ...
        }), M = L(), gb = v.getTimezone(), hb = v.getTimestamp(), ia = m.screen, cc = 64, lb = x.isIE() ? 512 : 2048,
        dc = x.isIE() ? 512 : 2048, zb = x.isIE() ? 100 : 400, Gb = 100, kb = "noindex",
        ...
        wc = new Ja({sampling: .01}), xc = +new Date, oa = "Metrika", qb, db, za = function () {
            return "1904"
        }();
    C.init().setSafe("counters", {}).setSafe("hitParam", {}).setSafe("counterNum", 0).setSafe("dataLayer", []).setSafe("hitId", h.random(1, 1073741824)).setSafe("_globalMetrikaHitId", h.random()).setSafe("v", za);
    Ea.globalConfig = C;
    oa = "Metrika2";
    m.Ya[oa] = function (a, b, c, d) {
        ...
        return F(function () {
            function l(a) {
                var b = u.referrer || "", c, d;
                if ((new RegExp("^https?://" + M.host + "/")).test(b)) return !1;
                var e = a.patterns;
                for (c = 0; c <
                e.length; c++) {
                    var f = new RegExp(e[c], "i");
                    if (b.match(f)) if (f = a.params || [], f.length) {
                        var g = h.safeDecodeURIComponent((RegExp.$1 || "").replace(/\+/g, "%20"));
                        for (d = 0; d < f.length; d++) if (g == h.safeDecodeURIComponent(f[d])) return !0
                    } else return !0
                }
                return !1
            }
            ...
            function g(a, b) {
                ...
                if (a && "string" != typeof a && a.length) for (d = 0; d < a.length; d++) {
                    ...
                    e = e.slice(1);
                    if ("#" == g) {
                        if (g = u.getElementById(e)) c = !0, b && fa.unshift([g, g.innerHTML]), g.innerHTML = f
                    } else if ("." == g) for (g =
            ...
            function r(a, b) {
                ...
                d && (d = -1 < d.indexOf(";") ? h.safeDecodeURIComponent(d) : Qa.decode(na.decode(d.replace(/[-*_]/g, function (a) {
                    return {"*": "+", "-": "/", _: "\x3d"}[a] || a
                }))));
            ...
            function p() {
                var p = !1, t = !1;
                ra || (t = U.initCookie(va), Ea.userInfo = U._userID, yb.init(C));
                Ea.initPU(P, C);
                x.isAndroidWebView() ||
                Ea.initPP(C);
                U.retransmit(C);
                wa && rc.init(wa, Z, a);
                C.get("pri") != A || x.isAndroidWebView() || (C.setSafe("pri", null), x.isPrivate(F(function (a) {
                    C.set("pri", a)
                }, "privCb")));
                Eb.subscribe(W);
                if (C.get("hitParam")[W]) {
                    if (1 != c || C.get("counters")[W]) return !1;
                    p = !0
                }
                C.get("counters")[W] = f;
                C.get("hitParam")[W] = 1;
                    ...
                    var v = function (e) {
                        ...
                        k.sendHit({
                            ...
                            callback: function (k, p) {
                                ...
                                ha(h.bind(mc, null, k));
                                q || Ea.initZZ();
                                k.eu !== A && C.set("isEU", k.eu);
                                Sa.init(p);
                                uc.match();
                                pc.sync(a, c, q, C);
                                d || S.log("PageView. Counter ", a, ". URL: ", M.href, ". Referrer: " + u.referrer, ". Params: ", b);
                                k.webvisor && (k.webvisor.isEU = C.get("isEU"));
                                if (!f.isDestructing()) {
                                    ...
                                    if (t) {
                                        b:{
                                            var aa = t.conditions;
                                            var ka;
                                            if (aa && aa.length) for (ka = 0; ka < aa.length; ka++) {
                                                var w = aa[ka];
                                                if ("ref" == w.type) w = l(w); else if ("adv" == w.type) {
                                                    var v;
                                                    var x = w;
                                                    var z = m.Ya._metrika.counter._directCampaign;
                                                    var B = x.ServiceNamePattern;
                                                    var D = x.RefererPattern;
                                                    w = z ? x.direct_orders : x.direct_camp;
                                                    var Ha = u.referrer, Aa = Ca.parse(M.search),
                                                        E = r(M.search, M.hash), F = {};
                                                    ...
                                                    var H = z ? "direct.yandex.ru" : E && E.service ||
                                                        F.source;
                                                    v = !1;
                                                    if (!v && B && B.length) for (G = 0; G < B.length; G++) if ((new RegExp(B[G], "i")).test(H)) {
                                                        v = !0;
                                                        break
                                                    }
                                                    if (!v && !x.yandex_direct && D && D.length) for (B = 0; B < D.length; B++) if ((new RegExp(D[B], "i")).test(Ha)) {
                                                        v = !0;
                                                        break
                                                    }
                                                    !v && x.google_adwords && Aa.gclid && (v = !0);
                                                    if (v && w && w.length && (v = !1, z = z || E && E.campaign || F && F.campaign)) for (x = 0; x < w.length; x++) if (w[x] == z) {
                                                        v = !0;
                                                        break
                                                    }
                                                    w = v
                                                ...
                                                if (w) {
                                                    aa[ka].track_id && q.create("mp2_track", aa[ka].track_id, 43200);
                                                    break b
                                                }
                                            }
                                        }
                                        aa = q.read("mp2_track");
                                        t = t.substs && t.substs[aa];
                                        aa && t ? (q.create("mp2_substs",
                                            h.toJSON(t)), q = g(t), f.params("__ym", q ? "mp_trackid" : "mp_trackid_bad", aa)) : n()
                                    } else n();
                ...
                q(!1);
                y.on(u, "click", k, null, {name: "extLinkClick"});
            ...
            function B(a) {
                var b =
                    new xa({frameConnector: P, globalConfig: C, initCounter: p, disable: N.yaDisableGDPR});
            ...
            function k(a) {
                if (f._trackLinks && f._trackLinks.on) {
                    a = x.findTarget(a);
                    var b = x.getLinkComponents(a), c = b.href, d = C.get("pai", h.noop)();
                    if (c && !w.classNameExists(a, "ym-disable-tracklink")) {
                        ...
                        if (w.classNameExists(a, "ym-external-link")) K.sendClickLink({
                            ...
                            (k ? k.replace(/^www\./, "") : "").toLowerCase() == (b ? b.replace(/^www\./, "") : "").toLowerCase() ? d.dl ? (d.ln = !1, K.sendClickLink({
                                ...
                                (d.ut = kb, K.sendClickLink({url: c, title: g, modes: d}, O))
                        }
                    }
                }
            }
            ...
            function D(a, b) {
                ...
                function e(a) {
                    var b;
                    for (b = 0; b < r.length; b += 3) if (a) y.on(r[b], r[b + 1], r[b + 2], {name: "tabTrack"}); else y.un(r[b], r[b + 1], r[b + 2])
                }

                var f = !1, g = !1, k = !0, l = 0, n = +new Date, q = null, p = !1;
                if (x.isIE()) h.setTimeout(a, b, "trackUserTime"); else {
                    var r = [m, "blur", function () {
                        ...
                        k = !1;
                        c()
                    }, u, "click", d, u, "mousemove", d, u, "keydown", d, u, "scroll", d];
                    e(!0);
                    c()
                }
            }
            ...
            function E(b) {
                var c = N.referrer ? Y : u.referrer, d = N.url ? O : L().href;
                "number" !== typeof b && (b = 15E3);
                if (!f._isAccurateTrackBounce) {
                    f._isAccurateTrackBounce = !0;
                    var e = new ea({counterId: a});
                    var g = e.get("lastHit");
                    e.set("lastHit", v.getMs());
                    ((e = e.get("lastHit")) && (!g || g < e - 18E5) || !Sb(c, d) || .1 > Math.random()) && D(function () {
                        f.notBounce();
                        Da.init(.002, ua)
                    }, b)
                }
            ...
            function G(a) {
                if (!1 === a) Ba && ("onhashchange" in m ? y.un(m, "hashchange", I) : h.clearTimeout(za), Ba = !1); else if (a = I, !Ba) {
                    if ("onhashchange" in m) y.on(m, "hashchange", a); else z(a);
                    Ba = !0
                }
                K.setTrackHash(Ba);
                f._trackHash = Ba
            ...
            function I() {
                var a = {ut: ia, ad: 1 == c && m.Ya && m.Ya.Direct, wh: !0, saveRef: !0, pv: !0};
                oa = Za.lastReferrer = da;
                K.sendAjaxHit({url: N.url ? O : L().href, title: w.getDocumentTitle(), referrer: oa, modes: a});
                da = L().href
            }
            ...
            var ia = "", N = {}, oa = "", da = Za.lastReferrer = M.href, ua = .002, ma = !1, qa;
            C.setSafe("counter", f);
            Pa && F(function () {
                throw Pa.error;
            }, "include." + Pa.scope)();
            ...
            if (!m["disableYaCounter" + a]) {
                ...
                c = c || 0;
                var W = a + ":" + c;
                if (C.get("counters")[W]) return S.log("Duplicate counter " + W + " initialization"), C.get("counters")[W];
                var Z = C.get("hitId");
                var P = new Mb({counterId: a, hid: Z});
                C.set("counterNum", C.get("counterNum") + 1);
                var pa = C.get("counterNum");
                var ha = lc(W, f);
                ha(nc);
                var K = new Ra({
                    protocol: "https:",
                ...
                var Da = {
                    init: function (a, b) {
                        if (m.performance && "function" === typeof performance.getEntriesByType) {
                            a === A && (a = 1);
                            b === A && (b = 1);
                            var c = Math.random() > a, d = Math.random() > b;
                            if (!c || !d) {
                                var e = {
                                        1882689622: 1,
                                        2318205080: 1,
                                        ...
                                        1417229093: 1,
                                        138396985: 1
                                    }, f = performance.getEntriesByType("resource"), g = {}, k = {},
                                    l = {counterId: 51533966}, n = {}, q;
                ...
                f.replacePhones = t(function () {
                    var b, c;
                    try {
                        (b = (new T({counterId: a})).read("mp2_substs")) && (c = R.parse(b)) && g(c, !0)
                    } catch (Ha) {
                    }
                    return f
                ...
                f.reachGoal = t(function (b, c, d, e) {
                    ...
                    K.sendGoal(b, {url: N.url ? O : L().href, vParams: c, callback: d, ctx: e});
                    return f
                }, "counter.reachGoal");
                ...
                var ya = new ea({counterId: a});
                f.hit = t(function (b, c, d, e, g, k) {
                ...
                f.params = t(function (b) {
                    var c = arguments.length, d = c, e = [].slice.call(arguments, 0);
                    if (b) {
                ...
                P.addHandler("parentConnect", function (a, b) {
                    K.paramsQueue.push({__ym: {parentIframe: {counterId: b.counterId, hid: b.hid}}})
                }, this);
                ...
                f.notBounce = t(function (a) {
                    ...
                    a = a || {};
                    qb && db && (b = db - qb);
                    K.sendNotBounce(b, {url: N.url ? O : L().href, callback: a.callback, ctx: a.ctx});
                    return f
                }, "counter.notBounce");
                var ta = [];
                ...
                f.userParams = t(function (a, b, c) {
                    h.isObject(a) ? f.params({__ymu: a}, b || function () {
                    }, c) : h.warning("Wrong user params");
                    return f
                }, "uparams");
                ...
                f.id = f.setUserID = t(function (a, b, c) {
                    h.isString(a) || h.isNumber(a) ? f.params({__ym: {user_id: a}}, b || function () {
                    }, c) : h.warning("Incorrect user ID");
                    return f
                }, "id");
                var Fa = new T;
                ...
                f.enableAll = t(function () {
                    q(!0);
                    e(!0);
                    E();
                    return f
                }, "enableAll", !0);
                f.uploadPage = t(function () {
                }, "uploadPage", !0);
                f.destruct = t(function () {
                    f._isDestructing = !0;
                    y.un(u, "click", k, null, {name: "extLinkClick"});
                    ...
                    e(!1);
                    try {
                        delete m["yaCounter" + a], delete C.get("counters")[W], delete C.get("hitParam")[W]
                    } catch (aa) {
                    }
                });
                ...
                if (a) {
                    ...
                    if ("prerender" === u.webkitVisibilityState || "prerender" ===
                        u.visibilityState) {
                        K.sendPrerenderHit({url: O, vParams: b, title: w.getDocumentTitle(), referrer: u.referrer});
                        var la = function () {
                            "prerender" !== u.webkitVisibilityState && "prerender" !== u.visibilityState && (y.un(u, "webkitvisibilitychange,visibilitychange", la), B(!0))
                        };
                        y.on(u, "webkitvisibilitychange,visibilitychange", la)
                    } else B(!1)
                }
            }
        }, "init")()
    ...
    Eb.init(oa, C);
    new Lb({globalConfig: C});
    m.Ya[oa].counters = function () {
        var a = [];
        h.forEachKey(C.get("counters"), function (b, c) {
            var d = b.split(":");
            a.push({
                id: +d[0],
                type: +d[1],
    ...
    C.setSafe("getCounters", function () {
        var a = [];
        h.forEachKey(C.get("counters"), function (b, c) {
            var d = b.split(":");
            a.push({
    ...
    (function () {
        ...
        var b = "yandex_metrika_callback", c = "yandex_metrika_callbacks";
    ...
    m.Ya[oa].informer = function (a) {
        ...
        b || w.loadScript({src: "https://informer.yandex.ru/metrika/informer.js"})
    };
    y.on(u, "click", F(function (a) {
        var b = X.getTarget(a);
        if (b && ("ym-advanced-informer" === b.className || b.classList && b.classList.contains("ym-advanced-informer"))) {
            ...
            m.Ya[oa].informer({i: b, id: +d, lang: c});
            X.prevent(a)
        }
